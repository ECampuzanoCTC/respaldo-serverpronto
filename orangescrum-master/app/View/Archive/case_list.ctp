...
?>
	...
	<tr class="tr_all all_first_rows" id="cslisting<?php echo $count; ?>" data-value="<?php echo $count; ?>">
		...
		<td>
			...
			<div class="fnt999"><?php echo __("Archived by"); ?> <font><?php echo $lis['User']['short_name'];?></font>
			<?php if(strpos($displayTime,'Today')===false && strpos($displayTime,'Y\'day')===false) echo __('on'); ?>
