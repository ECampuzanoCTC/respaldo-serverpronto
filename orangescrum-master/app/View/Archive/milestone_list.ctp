			...
			<table border="1" style="border:1px solid #DCDCDC" width="100%">
				<tr height="28px">
										...
										<div class="popup_link_case_proj_parent" style="position:relative;z-index:0;" align="left">
											...
											<div class="popup_option" id="popup_option" style="display:none;position:absolute;left:-22px;">
												...
												<div class="popup_con_menu" align="left" style="left:-1px; min-width:50px;padding: 2px 8px">
													<div align="left">    
														<div>
															<a href="javascript:void(0);" onclick="caseall();open_pop(this)" style="font-size:13px;font-weight:normal;"><?php echo __("All"); ?></a>
														</div>
										
										
														<div>
															<a href="javascript:void(0);" onclick="casenone();open_pop(this)" style="font-size:13px;font-weight:normal;"><?php echo __("None"); ?></a>
														</div>
										
										
														<div id="restore">
															<a href="javascript:void(0);" onclick="milestonerestoreall();" style="font-size:13px;font-weight:normal;"><?php echo __("Restore"); ?></a>
														</div>
										
														<div id="remove">
															<a href="javascript:void(0);" onclick="removeallmilestone();" style="font-size:13px;font-weight:normal;"><?php echo __("Remove"); ?></a>
														</div>
													</div>
												</div>
											</div>
					...
					<td  style="padding-left:4px;"valign="middle" align="left" class="tophead">Title</td>
                         <td  style="padding-left:4px;width:140px;"valign="middle" align="left" class="tophead"><?php echo __("Project Name"); ?></td>
					<td  style="padding-left:4px;width:80px;"valign="middle" align="left" class="tophead"><?php echo __("Created By"); ?></td>
					<td  style="padding-left:4px;width:160px;"valign="middle" align="left" class="tophead"><?php echo __("Start Date"); ?></td>
					<td  style="padding-left:4px;width:160px;"valign="middle" align="left" class="tophead"><?php echo __("End Date"); ?></td>
			...
			?>
				...
				<tr>
					<td colspan="7" align="center">
						<div style="width:100%;text-align:center;font-size:13px;color:#666666;list-style:none;margin:10px;"><?php echo __("No Milestone in the Archive"); ?></div>
					</td>
				</tr>
				<?php
					}
...
<table cellpadding="0" cellspacing="0" border="0" align="right" >
	...
	<tr>
		...
		if($page_limit < $total_records)
		{
			...
			if($data1)
			{
				echo "<li><a href='javascript:jsVoid();' class=\"button_act\" onClick=\"casePagingCase(1)\">&laquo; ".__('First')."</a></li>";
				echo "<li class='hellip'>&hellip;</li>";
			}
			if($page != 1)
			{
				$pageprev = $page-1;
				echo "<li><a href='javascript:jsVoid();' class=\"button_act\" onClick=\"casePagingCase('".$pageprev."')\">&lt;&nbsp;".__('Prev')."</a></li>";
			}
			else
			{
			...
			for($i = $k; $i <= $numofpages; $i++)
			{
				if($i == $page) {
					...
					echo "<li><a href='javascript:jsVoid();' class=\"button_act\" onClick=\"casePagingCase('".$i."')\">".__($i, true)."</a></li>";
				}
			}
			if(($total_records - ($page_limit * $page)) > 0)
			{
				$pagenext = $page+1;
				echo "<li><a href='javascript:jsVoid();' class=\"button_act\" onClick=\"casePagingCase('".$pagenext."')\">".__('Next')."&nbsp;&gt;</a></li>";
			}
			else
			{
				echo "<li><a href='javascript:jsVoid();' class=\"button_prev\">".__('Next')."&nbsp;&gt;</a></li>";
			}
			if($data2)
			{
				echo "<li class='hellip'>&hellip;</li>";
				echo "<li><a href='javascript:jsVoid();' class=\"button_act\" onClick=\"casePagingCase('".floor($lastPage)."')\">".__('Last')." &raquo;</a></li>";
			}
		}
		?>
		</ul>
