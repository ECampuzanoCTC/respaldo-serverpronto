...
<div class="scrl-ovr">
	...
	<?php
		...
		<tr id="mvtask_listings<?php echo $count; ?>" class="rw-cls <?php echo $class; ?>">	
		    ...
		    <td><div class="ad_cs" title="<?php echo $this->Format->formatTitle($milestoneTitle); ?>"><?php echo $this->Format->formatTitle($milestoneTitle); ?></div></td>
		...
		<tr valign="middle">
			<td colspan="7" align="center">
				<center class="fnt_clr_rd"><?php echo __("No Milestone(s) available."); ?></center>
			</td>
		</tr>
	    <?php } ?>
    </table>
