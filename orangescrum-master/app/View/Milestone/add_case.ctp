...
<div class="scrl-ovr">
	...
	<tr class="hdr_tr">
	    <th><input type="checkbox" class="chkbx_cur" onclick="selectMilestones(1,0,'checkAll')" id="checkAll"/></th>
	    <th><?php echo __("Task"); ?>#</th>
	    <th></th>
	    <th></th>
	    <th class="ml_title_wd"><?php echo __("Title"); ?></th>
	...
	<?php
		...
		<tr id="listings<?php echo $count; ?>" class="rw-cls <?php echo $class; ?>">	
			...
			<td class="tit_td_ml"><div class="ad_cs ad_cs_ml" title="<?php echo htmlentities($caseTitle); ?>"><?php echo htmlentities($caseTitle); ?></div></td>
			<td style="width:115px;"><div class="tsk_sts tsk_sts_dpl"> <?php echo $this->Format->getStatus($caseTypeId, $caseLegend); ?></div></td>
		    <td>
			<?php
