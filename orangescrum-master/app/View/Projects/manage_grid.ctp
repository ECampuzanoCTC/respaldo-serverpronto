...
<div class=" task_lis_page">
    <div class="task_listing">
        <div class="proj_grids glide_div" id="project_grid_div">
            ...
            <div class="fr pos_ets_btn"><button type="button" value="Export" name="Export" class="btn btn_blue" onclick="export_prjtlstng()"><?php echo __("Export Project"); ?> (.csv)</button></div>
            <div class="cb"></div>
            <div class="m-cmn-flow">
                <table id="grid-keep-selection" class="table table-condensed table-hover table-striped m-list-tbl">
                    <thead>
                        <tr>
                            ...
                            <th class="tophead manage-list-th2 order-column"><?php echo __("Project Name"); ?></th>
                            <th class="text-center tophead manage-list-th3 order-column"><?php echo __("Short Name"); ?></th>
                            <th class="tophead manage-list-th4"><?php echo __("Description"); ?></th>
                            <th class="text-center tophead manage-list-th5" ><?php echo __("Status"); ?></th>
                            <th class="text-center tophead manage-list-th6 order-column">#<?php echo __("Tasks"); ?></th>
                            <th class="text-center tophead manage-list-th7 order-column">#<?php echo __("Users"); ?></th>
                            <?php if(defined('DBRD') && DBRD == 1) { ?>
                            <th class="text-center tophead manage-list-th8 order-column"><?php echo __("Start");?><br /><?php echo __("Date"); ?></th>
                            <th class="text-center tophead manage-list-th9 order-column"><?php echo __("End"); ?><br /><?php echo __("Date"); ?></th>
                            <th class="text-center tophead manage-list-th10 order-column"><?php echo __("Estimated Hour(s)"); ?></th>
                            <th class="text-center tophead manage-list-th11 order-column"><?php echo __("Number Of Days"); ?></th>
                            <?php } ?>
                            <th class="text-center tophead manage-list-th12 order-column"><?php echo __("Storage"); ?><br /><?php echo __("Used(Mb)"); ?></th>
                            <th class="text-center tophead manage-list-th13 order-column"><?php echo __("Hour(s)"); ?><br /><?php echo __("Spent"); ?></th>
                            <th class=" tophead manage-list-th14"><?php echo __("Last Activity"); ?></th>
                        </tr>
                    </thead>
                    <?php
                    //}
                   // echo "<pre>";print_r($prjAllArr);exit;
                    if (count($prjAllArr)) {
                        foreach ($prjAllArr as $k => $prjArr) {
                            ...
                            $totHours = (!empty($prjArr[0]['totalhours'])) ? floor($prjArr[0]['totalhours']/3600)." hrs ".(($prjArr[0]['totalhours']%3600)/60)." min" : '0';
                            ?>
                            <?php
                            ...
                            $sts_txt = $prjArr['Status']['project_status'] ;
                            $hrs = floor($totHours/3600)." hrs ".(($totHours%3600)/60)." min";
                          /*  if ($prjArr['Project']['isactive'] == 1 && $prjArr['Project']['status'] == 1) {
                            ...
                            <tr class="row_tr prjct_lst_tr">
                                <td class="text-center">
                                    <input type="hidden" value="<?php echo $prjArr['Project']['dt_created']; ?>">
                                    <div class="dropdown">
                                        ...
                                        <?php if (SES_TYPE == 1 || SES_TYPE == 2 || (SES_TYPE == 3 && $prjArr['Project']['user_id'] == SES_ID)) { ?>
                                            <ul class="dropdown-menu " >
                                                ...
                                                <?php if ($projtype == 'active-grid') { ?>
                                                 <?php
                                                    if (defined('ROLE') && ROLE == 1 && array_key_exists('Add Users to Project', $roleAccess) && $roleAccess['Add Users to Project'] == 0) {
                                                    ...
                                                    <li id="remove<?php echo $prjArr['Project']['id']; ?>">
                                                        ...
                                                        <?php
                                                            if (defined('ROLE') && ROLE == 1 && array_key_exists('Remove Users from Project', $roleAccess) && $roleAccess['Remove Users from Project'] == 0) {
                ...
                <?php } ?>
                                                   ...
                                                   <?php if(SES_TYPE < 3){if(defined('ROLE') && ROLE == 1){ // && array_key_exists('Edit Project', $roleAccess) && $roleAccess['Edit Project'] == 0){}else{ ?>
                                                    <li><a href="javascript:void(0);" class="icon-assgn-role" data-prj-id="<?php echo $prjArr['Project']['id'];?>" data-prj-name="<?php echo $prj_name;?>"><i class="glyphicon glyphicon-plus-sign "></i><?php echo __("Assign Role"); ?></a></li>
                                                   <?php } }?>
                                                    <?php
                                                    if (defined('ROLE') && ROLE == 1 && array_key_exists('Edit Project', $roleAccess) && $roleAccess['Edit Project'] == 0) {
                                                    ...
                                                    <li>
                                                        ...
                                                        <?php
                                                            if (defined('ROLE') && ROLE == 1 && array_key_exists('Disable Project', $roleAccess) && $roleAccess['Disable Project'] == 0) {
                                                         ...
                                                         <?php } ?>
                                                                <?php } else { ?>
                                                            <?php
                                                            if (defined('ROLE') && ROLE == 1 && array_key_exists('Delete Project', $roleAccess) && $roleAccess['Delete Project'] == 0) {
                                                ...
                                                <?php } else { ?>
                                                    <?php if(defined('ROLE') && ROLE == 1 && array_key_exists('Enable Project', $roleAccess) && $roleAccess['Enable Project'] == 0){}else{ ?>
                                                    ...
                                                    <?php } ?>
                                                    <?php if(defined('ROLE') && ROLE == 1 && array_key_exists('Delete Project', $roleAccess) && $roleAccess['Delete Project'] == 0){}else{ ?>
                                            ...
                                            <ul class="dropdown-menu" <?php if (SES_TYPE == 3 && $prjArr['Project']['user_id'] != SES_ID) { ?>onclick="notAuthAlert();"<?php } ?>>
                                                ...
                                                if ($projtype == 'active-grid') {
                                                    if ($prjArr['Project']['isactive'] == 2 || $prjArr['Project']['status'] == 4) {
                                                        ?>
                                                        <li><a href="javascript:void(0);"><?php echo __("Not Complete"); ?></a></li>
                                                        <li><a href="javascript:void(0);"> <?php echo __("Delete"); ?></a></li>
                <?php } else { ?>
                                                        <li><a href="javascript:void(0);"> <?php echo __("Add User"); ?></a></li>
                                                        <li>
                                                            <?php if (!empty($prjArr[0]['totusers'])) { ?>
                                                                <a href="javascript:void(0);"> <?php echo __("Remove User"); ?></a>
                    <?php } ?>
                                                        </li>
                                                        <li style="display:none;">
                                                            <a href="javascript:void(0);"> <?php echo __("Remove User"); ?></a>
                                                        </li>
                                                        <li><a href="javascript:void(0);"> <?php echo __("Edit"); ?></a></li>
                                                        <li>
                                                            <?php if ($prjArr[0]['totalcase']) { ?>
                                                                <a href="javascript:void(0);"> <?php echo __("Complete"); ?></a>
                                                            <?php } else { ?>
                                                                <a href="javascript:void(0);"> <?php echo __("Delete"); ?></a>
                                                        <?php } ?>
                                                        </li>
                                                    <?php
                                                    }
                                                    ...
                                                    ?>
                                                    <li><a href="javascript:void(0);"><?php echo __(" Not Complete"); ?></a>
                                                    </li>
                                                    <li><a href="javascript:void(0);"><?php echo __(" Delete"); ?></a></li>
                                            <?php } ?>                            
                                            </ul>
        ...
        <?php } ?>
                                ...
                                <td align="left"><a class="ttl_listing" id="prj_ttl_<?php echo $prjArr['Project']['uniq_id']; ?>" href="<?php echo HTTP_ROOT ?>dashboard/?project=<?php echo $prjArr['Project']['uniq_id']; ?>#tasks" title="<?php echo $tooltip; ?>" onclick="return projectBodyClick('<?php echo $prjArr['Project']['uniq_id']; ?>');"><?php echo $prj_name_shrt; ?>&nbsp;</a><br />
                                    <span style="color:#8d8d8e;font-size:12px;">
                                        ...
                                        ?>
        <?php $mix_nams = $user_names[$prjArr['Project']['user_id']];
						if($mix_nams != ''){
                                                        if($prjArr['Project']['user_id'] == SES_ID){
                                                            $mix_nams = 'me';
                                                        }
						...
						echo $mix_nams;?>
                                ...
                                <td class="text-center"><?php echo $this->Format->formatTitle($sts_txt); ?></td>
                                ...
                                <td class="text-center">
                                    ...
                                    if($prjArr['Project']['start_date']){
                                        ...
                                        echo $this->Format->chngdate($prjArr['Project']['start_date']);
                                    } else{
                                        echo __("No Start Date") ;
                                    }
                                        ?>
                                </td>
                                <td class="text-center">
                                    ...
                                    if($prjArr['Project']['end_date']){
                                        ...
                                        echo $this->Format->chngdate($prjArr['Project']['end_date']);
                                    } else {
                                        echo __("No End Date") ;
                                    }
                                ...
                                <td class="text-center"><?php echo $totHours ; ?></td>
                                <td>
                                    <?php
    ...
    if (defined('CR') && CR == 1 && SES_CLIENT == 1 && $this->Format->get_client_permission('project') == 1) {
        ...
        ?> 
    <?php
    if (defined('ROLE') && ROLE == 1 && array_key_exists('Create Project', $roleAccess) && $roleAccess['Create Project'] == 0) {
