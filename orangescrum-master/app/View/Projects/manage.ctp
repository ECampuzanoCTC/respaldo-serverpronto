...
<div class="col-lg-12 prj_div" style="margin-top:30px">
	...
	<?php } $ik = $ik++; ?>
        <div class="usr_mcnt fl cmn_bdr_shadow pr cmn_overflow <?php if($projtype == 'inactive' || $projtype == 'inactive-grid') { ?>inactv<?php } ?> "
			...
			$len = 23;
						$prj_name_shrt = $prj_name;
						$tooltip =$prj_name;
		    ?>
                            <?php if ($projtype == '') { ?>
                             <?php if($prjArr['Project']['user_id'] == SES_ID || SES_TYPE <=2){ ?>  
                        <?php if(defined('ROLE') && ROLE == 1 && array_key_exists('Add Users to Project', $roleAccess) && $roleAccess['Add Users to Project'] == 0){}else{ ?>
                        ...
                        <?php } ?>
                            ...
                            <?php if(defined('ROLE') && ROLE == 1 && array_key_exists('Remove Users from Project', $roleAccess) && $roleAccess['Remove Users from Project'] == 0){}else{ ?>
                        ...
                        <li><a href="javascript:void(0);" class="icon-assgn-role" data-prj-id="<?php echo $prjArr['Project']['id'];?>" data-prj-name="<?php echo $prj_name;?>"><i class="glyphicon glyphicon-plus-sign "></i><?php echo __("Assign Role"); ?></a></li>
                             <?php } }?>
                        <?php /* #if(defined('ROLE') && ROLE == 1 && array_key_exists('Edit Project', $roleAccess) && $roleAccess['Edit Project'] == 0){}else{ ?>
                        <li><a href="javascript:void(0);" class="icon-manage-role" data-prj-id="<?php echo $prjArr['Project']['id'];?>" data-prj-name="<?php echo $prj_name;?>"><i class="glyphicon glyphicon-plus-sign "></i><?php echo __("Manage Role"); ?></a></li>
                        <?php #} */?>
                        ...
                        <?php if(defined('ROLE') && ROLE == 1 && array_key_exists('Edit Project', $roleAccess) && $roleAccess['Edit Project'] == 0){}else{ ?>
                            ...
                            <?php if(defined('ROLE') && ROLE == 1 && array_key_exists('Disable Project', $roleAccess) && $roleAccess['Disable Project'] == 0){}else{ ?>
				...
				<div class="proj_created_by">
					...
					<?php 
						...
						if($mix_nams != ''){
							$mix_nams = __('Created by ',true).''.$mix_nams.''.__(' on ',true).''.$dateTime ;
						}else{
							$mix_nams = __('Created',true).' '. __('on',true).' '. $dateTime;
						}
						echo $mix_nams; ?>
				</div>
...
<?php if(defined('CR') && CR == 1 && SES_CLIENT ==1 && $this->Format->get_client_permission('project')==1){ 
    ...
    <?php if(defined('ROLE') && ROLE == 1 && array_key_exists('Create Project', $roleAccess) && $roleAccess['Create Project'] == 0){}else{ ?>
