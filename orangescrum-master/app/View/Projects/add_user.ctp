<table cellpadding="0" cellspacing="0" class="col-lg-12 ad_prj_usr_tbl ad_prj_usr_ipad">
	...
	<table cellpadding="0" cellspacing="0" class="col-lg-12 users_no" style="width:100%">
		<tr class="hdr_tr">
		    <th class="nm_ipad" style="padding-left:10px;background: none repeat scroll 0 0 #ABBAC3;color: #FFFFFF;"><?php echo __("User(s) in this"); ?><?php //echo $this->Format->formatText($pjname); ?> Project</th>
		</tr>
		<?php
