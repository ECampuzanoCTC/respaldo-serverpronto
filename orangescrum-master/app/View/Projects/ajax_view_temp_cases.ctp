...
<div class="popup_form">
	...
	<tr>
		...
		<div style="height:400px;overflow:auto">
			...
			<tr>
				...
				<div style="max-height:350px; overflow:auto">
					...
					<tr height="28px" class="tophead">
					    ...
					    <td style="padding-left:10px;"><?php echo __("Title"); ?></td>
					    <td style="padding-left:10px;"><?php echo __("Description"); ?></td>
			...
			<center style="font-weight:normal;color:#FF0000;padding:10px;"><?php echo __("No tasks(s) available."); ?></center>
			</td>
