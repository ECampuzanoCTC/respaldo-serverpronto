                               ...
                               <table bgcolor="#FFF" border="0" cellspacing="0" cellpadding="10" width="100%">
                                    <tr>
                                        <td style="border-top:6px solid #3dbb89;">
                                            <table bgcolor="#FFF" border="0" cellspacing="0" cellpadding="0" width="100%">
                                                <tr>
                                                    <td align="left" colspan="3"><h2>Payment</h2></td>                                                    
                                                </tr>
                                                <tr>
                                                    <td align="left" style="width:20%">Payment#:</td>
                                                    <td align="left" style="width:30%"><?php echo $i['Payment']['payment_no']; ?></td>
                                                    <td align="right" style="width:40%;font-size:22px;">Amount: <?php echo $i['Payment']['currency'] ?> <?php echo $this->Format->format_price($i['Payment']['price']); ?></td>
                                                </tr>
                                                <tr>
                                                    <td align="left">Generation Date:</td>
                                                    <td align="left" colspan="2"><?php echo $this->Format->get_date($i['Payment']['issue_date']); ?></td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td width="100%" bgcolor="#FFF" style="text-align:left;">
                                            ...
                                            <?php /* ?>
                                              <p>
                                              Dear <?php $name = $this->Format->getUserDtls($i['Invoice']['user_id']);
                                              echo $name['User']['name'];?>.
                                              </p>
                                              <p>Your Generated Invoice is attached . please <a href="<?php print $f;?>">click here</a> to download Your invoice.</p>
                                              <p>Regards,<br/>
                                              The Orangescrum Team</p><?php */ ?>
                                        </td>
                                    </tr>
                                </table>
        ...
        <tr>
            <td width="100%" bgcolor="#ffffff" style="text-align:center;">
                <p style=" font-family:Arial, Helvetica, sans-serif; font-size:11px; line-height:14px; margin-top:0; padding:0; font-weight:normal;padding-top:5px;">
                    &#169; Copyright <?php echo gmdate('Y'); ?> Orangescrum. All Rights Reserved.<br/>
