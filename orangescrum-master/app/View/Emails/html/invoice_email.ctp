                                    ...
                                    <tr>
                                        <td style="border-top:6px solid #3dbb89;">
                                            <table bgcolor="#FFF" border="0" cellspacing="0" cellpadding="0" width="100%">
                                                <tr>
                                                    <td align="left" colspan="3"><h2>Invoice</h2></td>                                                    
                                                </tr>
                                                <tr>
                                                    <td align="left" style="width:20%">Invoice#:</td>
                                                    <td align="left" style="width:30%"><?php echo $i['Invoice']['invoice_no']; ?></td>
                                                    <td align="right" style="width:40%;font-size:22px;">Amount: <?php echo $i['Invoice']['currency'] ?> <?php echo $this->Format->format_price($i['Invoice']['price']); ?></td>
                                                </tr>
                                                <tr>
