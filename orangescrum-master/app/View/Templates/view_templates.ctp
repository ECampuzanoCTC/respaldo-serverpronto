...
<table width="98%" class="tsk_tbl arc_tabs caselistall" id="caselist" style="margin-top:10px;">
	<tr style="" class="tab_tr">
		...
		<td width="66%">
			<div class="fl"><?php echo __("Description"); ?></div>
		</td>        
	</tr>
	<?php
	...
	<?php } }else{ ?>
		<tr>
			<td colspan="3" style="color:#FF0000;" align="center"><?php echo __("No tasks found"); ?></td>
		</tr>
	<?php } ?>
</table>
				 ...
				 <div class="user-details templt-mng">
					...
					<div class="fl create_temp">
						...
						<?php
							if($template['case_templates']['is_active'] == 1){
								$classTemp = 'activate_task_temp';
								$nameTitle = __('Enabled');
							}else{
								$classTemp = 'deactivate_task_temp';
								$nameTitle = __('Disabled');
							}
						?>
							<div class="<?php echo $classTemp; ?>" id="actdeact_<?php echo $template['case_templates']['id']; ?>">
								<?php echo $nameTitle; ?>
				...
				<div class="proj_mng">
					<div class="fl">
						<?php
							if($template['case_templates']['is_active'] == 1){
						?>
							<span class="icon-enable-temp-task fl"><?php echo __("Enable"); ?></span><br/>
						<?php }else{ ?>
						...
						<?php
							if($template['case_templates']['is_active'] == 0){
						?>
							<span class="icon-disable-temp-task fl"><?php echo __("Disable"); ?></span>
						<?php }else{ ?>	
