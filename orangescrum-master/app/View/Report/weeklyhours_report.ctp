...
<div class="fl wkview" style="padding:5px;border:1px solid grey;"><a href='javascript:void(0);' onclick="anotherwk('','');" style='text-decoration:none;color:black;font-size:15px;font-family:"Helvetica Neue",Arial,Verdana,"Nimbus Sans L",sans-serif'><?php echo __("This Week"); ?></a></div>
...
<?php $daytot = array(); ?>
	...
	<tbody>
		...
		<?php } else { ?>
			 ...
			 <?php	print '<div style="min-height:50px;text-align:center;margin-top:25px;">'.__("No Data for this week").'.</div>';
			} 
