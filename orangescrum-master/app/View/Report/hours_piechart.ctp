...
$(function(){
        $('#piechart').highcharts({
            ...
            tooltip: {
        	    formatter: function() {
                            return '<b><?php echo __("Total Hours"); ?>: </b>'+this.point.hours+'<br><b>'+ this.point.name +'</b>: '+ parseFloat((this.point.percentage).toPrecision(3)) +' %';
                    }
