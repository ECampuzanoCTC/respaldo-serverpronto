...
<div class="wrapper_help">
    ...
    <a href="<?php echo HTTP_ROOT."help"; ?>">
        <div class="sub_div">
            ...
            <div class="sub_txt fl"><?php echo __("General Questions"); ?></div>
            <div class="cb"></div>
        </div>
    </a>
    <a href="<?php echo $this->Html->url('/users/tour');?>">
        <div class="sub_div">
            ...
            <div class="sub_txt fl" style="margin-top: 13px;"><?php echo __("Features"); ?></div>
			 <div class="cb"></div>
        </div>
    </a>
    ...
    <div class="sub_div">
        ...
        <div class="sub_txt fl"><?php echo __("How it works?"); ?></div>
        <div class="cb"></div>
    </div>
