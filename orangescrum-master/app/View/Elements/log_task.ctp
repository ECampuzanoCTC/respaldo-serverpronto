    ...
    <div class="logtime-content">
        <div style="padding: 20px 30px 0; width: 100%;">
            ...
            <div class="spent-time fr" id="tl-msg-box">
                ...
                <div class="fl" style="margin:0px 20px;"><span class="use-time"><?php echo __('Billable');?>: </span><span id='logtime_billable'>---</span></div>
                ...
                <ul id="ul_timelog1">
                    ...
                    <li>
                        <div class="margin15" style="margin-left:10px">
                            ...
                            <span style="">Auto generate invoice on task close?</span>
                        </div>
                    </li>
               <?php  }?>
