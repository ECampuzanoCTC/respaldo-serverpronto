...
<table cellpadding="0" cellspacing="0" class="col-lg-12 new_proj_temp_new_tab">
    <tbody id="parent-mlsts-tbody">
        ...
        var mlst_startdate = moment(ProjectTemplateMilestone[mlstKey]['start_date'], 'YYYY-MM-DD').isValid() ? moment(ProjectTemplateMilestone[mlstKey]['start_date'],'YYYY-MM-DD').format(date_format) : "";
        var mlst_endate = moment(ProjectTemplateMilestone[mlstKey]['end_date'], 'YYYY-MM-DD').isValid() ? moment(ProjectTemplateMilestone[mlstKey]['end_date'],'YYYY-MM-DD').format(date_format) : "";
        ...
        <div>
            ...
            <table cellpadding="0" cellspacing="0" class="col-lg-12 pr_templ_mlstn_tsks" style="" id="tmpl_mlstns_task_form_<%= mlstn_cntr %>">
                <tbody id="tmpl_mlstns_task_form_tbody_<%= mlstn_cntr %>">
                    ...
                    var mlst_tsk_startdate = moment(mlstn_cases[mlstcasesKey]['start_date'], 'YYYY-MM-DD').isValid() ? moment(mlstn_cases[mlstcasesKey]['start_date'],'YYYY-MM-DD').format(date_format) : "";
                    var mlst_tsk_endate = moment(mlstn_cases[mlstcasesKey]['end_date'], 'YYYY-MM-DD').isValid() ? moment(mlstn_cases[mlstcasesKey]['end_date'],'YYYY-MM-DD').format(date_format) : "";
