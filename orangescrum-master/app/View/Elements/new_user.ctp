...
<table cellpadding="0" cellspacing="0" class="col-lg-12 new_auto_tab">
    ...
    <tr>
	<td class="v-top">
	    <?php echo __("Project to be"); ?><br/><?php echo __("assigned"); ?>: <br/>
	</td>
    ...
    <tr>
	<td class="v-top">
	    <?php echo __("Assign Role"); ?>: <br/>
	</td>
	<td>
	<?php	echo $this->Form->input('role_id', array('type' => 'select', 'label' => false, 'options' => $rolelist, 'id' => 'select_role', 'class' => 'form-control','empty'=>'Select Role'));
 ...
 <div style="padding-left:124px;"> 
		...
		?>
    	    <font color="#FF0000"><?php echo __("Sorry, User Limit Exceeded!"); ?></font>
    	    <br/>
    	    <font color="#F05A14"><a href="<?php echo HTTP_ROOT; ?>pricing"><?php echo __("Upgrade"); ?></a> <?php echo __("your account to create more users"); ?></font>
		<?php
	    } else {
		?>
		...
		<button type="submit" value="Add" name="addMember" class="btn btn_blue"><i class="icon-big-tick"></i><?php echo __("Add"); ?></button>
