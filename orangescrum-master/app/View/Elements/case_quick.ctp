...
<div>
	...
	<div class="case_field">
		<table cellpadding="0" cellspacing="0" width="100%">
			<tr>
				...
				<td align="left" id="milestone_td">
					<div class="col-lg-3 lbl-m-wid" style="padding-left:0;width:110px;"><?php echo __("Milestone"); ?>:</div>
					<div class="col-lg-6 rht-con">	
						<div class="fl dropdown option-toggle p-6" style="margin-left: 6px;text-align:left">
	...
	<div class="case_field" style="margin:15px 0 10px">
		<span>
			<div class="fl lbl-m-wid"><?php echo __("Description"); ?>:</div>
			<div id="divNewCase" class="createtask fl rht-con">
	...
	<div class="clear"></div>
    <?php if(defined('ROLE') && ROLE == 1 && array_key_exists('Upload File to Task', $roleAccess) && $roleAccess['Upload File to Task'] == 0){}else{ ?>
	<div class="case_field">
