                    ...
                    <td align="center">
                        <div id="divToPrint" style="font-family:verdana;font-size:12px;color:#333;padding:0;margin:5px 0 0;border:1px solid #ccc;float:left;width:100%;">
                            <div style="background:#353C42;padding:5px 10px;margin-bottom:15px;">
                                <div class="ellipsis-view" rel="tooltip" title="<?php echo ucfirst(CMP_SITE); ?>" style="float:left;color:#FFF;font-size:26px;font-weight:bold;max-width:400px"><?php echo ucfirst(CMP_SITE); ?></div>
                                <div style="float:right;color:#fff;font-size:14px;">
                                    <div title="Current Week" class="fr" style="font-size:13px;text-align:right;font-weight:bold">
                                        <?php
                                        $cwfrom = $this->Datetime->short_facebook_datestyle(date("D, M d", (strtotime($dateCurnt) - ($days_diff * 24 * 60 * 60))));
                                        $cwto = $this->Datetime->short_facebook_datestyle(date("D, M d", strtotime($dateCurnt)));
                                        echo $cwfrom . "&nbsp;-&nbsp;" . $cwto;
                                        ?> 
                                    </div>
                                    <div class="cb"></div>
                                    <div title="Last Week" class="fr" style="font-size:9px;text-align:right;padding-bottom:0px;padding-top: 5px;color: #E0E0E0;">Last Week:&nbsp;&nbsp;
                                        <?php
                                        $lwfrom = $this->Datetime->short_facebook_datestyle(date("D, M d", (strtotime($last_week_date))));
                                        $lwto = $this->Datetime->short_facebook_datestyle(date("D, M d", strtotime($prv_date) - (24 * 60 * 60)));
                                        echo  $lwfrom. "&nbsp;-&nbsp;" . $lwto;
                                        ?> 
                                    </div>  
                                </div>
                            ...
                            <div style="padding:10px">
                                ...
                                ?>
                                <div style="padding:5px;background:#ECECEC;font-size:15px;font-weight:bold;text-align:left;"><?php echo __("Statistics"); ?> - <span style="font-size:12px;;color:#676767"><?php echo __("SO FAR THIS WEEK"); ?></span></div><br/>
                                <div>
                                    <div style="float:left">
                                        <div class="week_rpt_div" style="border-top:1px solid <?php echo $logedin_color; ?>">
                                            ...
                                            <div style="color:#666666;margin-top:5px;font-weight:bold"><?php echo __("Logged in User"); ?></div>
                                            <div style="clear:both"></div>
                                            <?php if ($progress_flag) { ?>
                                                <div style="width:120px;background:<?php echo $logedin_color; ?>;padding:4px;color:#FFFFFF;font-size:11px;margin:0 auto;-moz-border-radius: 2px;border-radius: 2px;margin-top:10px;">
                                                    <?php echo $loggedin_per . '% ' . __("of Total") . ' ' . $userlogin[0][0]["tot"]; ?>
                                                </div>
                                                <div style="color:#666666;margin-top:3px;"><?php echo __("Last Week to Date"); ?></div>
                                            <?php } ?>
                                        </div>
                                    </div>
                                    <div style="float:left">
                                        <div id="tcreate_main" class="week_rpt_div" style="border-top:1px solid #696969;border-left:4px solid #FFF">
                                            ...
                                            <div style="clear:both"></div>
                                            <div id="task_created" >
                                                <span style="font-size: 11px;"><?php echo __("Loading..."); ?></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div style="float:left">
                                        <div id="tupdate_main" class="week_rpt_div" style="border-top:1px solid #696969;border-left:4px solid #FFF">
                                            ...
                                            <div style="clear:both"></div>
                                            <div style="color:#666666;margin-top:5px;font-weight:bold"><?php echo __("Tasks Updated"); ?></div>
                                            <div style="clear:both"></div>
                                            <?php if ($progress_flag) { ?>
                                                <div id="task_update">	
                                                    <span style="font-size: 11px;"><?php echo __("Loading..."); ?></span>
                                ...
                                <div>
                                    <div style="float:left">
                                        <div id="tclosed_main" class="week_rpt_div" style="border-top:1px solid #696969;">
                                            ...
                                            <div style="clear:both"></div>
                                            <div style="color:#666666;margin-top:5px;font-weight:bold"><?php echo __("Tasks Closed"); ?></div>
                                            <div style="clear:both"></div>
                                            <?php if ($progress_flag) { ?>
                                                <div id="task_closed"><span style="font-size: 11px;"><?php echo __("Loading..."); ?></span></div>
                                            <?php } ?>
                                        </div>
                                    </div>
                                    <div style="float:left">
                                        <div id="hours_main" class="week_rpt_div" style="border-top:1px solid #696969;border-left:4px solid #FFF">
                                            <div id="hours_text" style="font-size:28px;color:#696969;font-weight:bold"><?php echo defined('TLG') && TLG == 1 ? $this->format->format_time_hr_min($curr_wk_tot_hr_spent) : $curr_wk_tot_hr_spent . ' hrs'; ?></div>
                                            <div style="clear:both"></div>
                                            <div style="color:#666666;margin-top:5px;font-weight:bold"><?php echo __("spent"); ?></div>
                                            <div style="clear:both"></div>
                                            <?php if ($progress_flag) { ?>	
                                                <div id="task_hours_spent" > <span style="font-size: 11px;"><?php echo __("Loading..."); ?></span></div>
                                            <?php } ?>
                                        </div>
                                    </div>
                                    <div style="float:left">
                                        <div id="storage_main" class="week_rpt_div" style="border-top:1px solid #696969;border-left:4px solid #FFF">
                                            ...
                                            <div style="clear:both"></div>
                                            <div style="color:#666666;margin-top:5px;font-weight:bold"><?php echo __("Storage Used"); ?></div>
                                            <div style="clear:both"></div>
                                            <?php if ($progress_flag) { ?>
                                ...
                                <div style="clear:both"></div><br/>
                                <div style="padding:10px;background:#F3F3F3;font-size:15px;font-weight:bold;text-align:left;"><?php echo __('Task Status of the Week'); ?></div><br/> <div style="clear:both"></div>
                                <div style="border:1px solid #EEEEEE;background:#F8F8F8;box-shadow:0px 0px 1px #fff inset">
                                    <div class="weekly_task_col" style="text-align:center;"><?php echo __("Date"); ?></div>
                                    <div class="weekly_task_col" style="text-align:right;"><?php echo __("Task Created"); ?></div>
                                    <div class="weekly_task_col" style="text-align:right;"><?php echo __("Task Updated"); ?></div>
                                    <div style="clear:both"></div>
                                    <?php
                                    foreach ($last7days as $key1 => $val1) {
                                        ...
                                        <div class="weekly_task_col" style="text-align:center;font-weight:normal">
                                            <?php echo $this->Datetime->short_facebook_datestyle($val1); ?>
                                        </div>
                                ...
                                if ($getProj) {
                                    ?>
                                    <div style="clear:both"></div><br/>
                                    <div style="padding:10px;background:#F3F3F3;font-size:15px;font-weight:bold;text-align:left;"><?php echo __("Project Status of the Week"); ?></div><br/><div style="clear:both"></div>
                                    <div style="border:1px solid #EEEEEE;background:#F8F8F8;box-shadow:0px 0px 1px #fff inset">
                                        <div class="weekly_proj_col" style="text-align:left;"><?php echo __("Project"); ?></div>
                                        <div class="weekly_proj_col" style="text-align:right;"><?php echo __("Closed/Total Tasks"); ?></div>
                                        <div class="weekly_proj120_col" style="text-align:right;"><?php echo __("Hours"); ?></div>
                                        <div class="weekly_proj120_col" style="text-align:right;"><?php echo __("Usage"); ?></div>
                                        <div style="clear:both"></div>
                                        <?php
                                        foreach ($getProj AS $pkey => $pval) {
                                            ...
                                            <div class="weekly_proj120_col" style="text-align:right;font-weight:normal">
                                                <?php echo defined('TLG') && TLG == 1 ? $this->format->format_time_hr_min($tot_hrs) : $tot_hrs; ?>
                                            </div>
                                            <div class="weekly_proj120_col" style="text-align:right;font-weight:normal">
                                ...
                                <?php } else { ?>
                                    <div style="clear:both"></div><br/><div style="padding:10px;background:#F3F3F3;font-size:15px;font-weight:bold;text-align:left;"><?php echo __("No Project Status on last week"); ?></div><br/><div style="clear:both"></div>
                                <?php } ?>
                                <div style="clear:both"></div><br/><div style="padding:5px;background:#ECECEC;font-size:15px;font-weight:bold;text-align:left;"><?php echo __("Summary"); ?></div>
                                <div style="text-align:left;">
                                    <ul>
                                        <li>
                                            <b><?php echo $userlogin[0][0]['notlogged']; ?></b> <?php echo __("Out of"); ?> <b><?php echo $userlogin[0][0]['tot']; ?></b> <?php echo __("User has not logged in to the system since last week"); ?>.
                                        </li>
                                        <li>
                                            <b><?php echo $total_task_cr_current_week; ?></b> <?php echo __("tasks created and"); ?> <b><?php echo $total_task_upd_current_week; ?></b> <?php echo __("updated on last week"); ?>
                                        </li>
                                        <li>
                                            <b><?php
                                                $hrspnt = $curr_wk_tot_hr_spent;
                                                if (defined('TLG') && TLG == 1) {
                                                    $hrspnt = $this->format->format_time_hr_min($curr_wk_tot_hr_spent);
                                                }
                                                echo $curr_wk_tot_closed_tasks . '</b> closed out of <b>' . $total_task_cr_current_week . '</b> tasks, <b>' . $hrspnt . '</b> hours spent and <b>' . $curr_wk_tot_storage_usage;
                                                ?></b> Mb <?php echo __("storage used on all projects"); ?>
                                        </li>
                                    </ul>
                                </div><br/>
                            </div>
...
<?php } ?>
        $.post(HTTP_ROOT + 'reports/ajax_statistics', {'project_idlists': project_idlists}, function (res) {
            ...
            //Hours spent data 
            var hspent = '<div style="width:120px;background:' + hstask_color + ';padding:4px;color:#FFFFFF;font-size:11px;margin:0 auto;-moz-border-radius: 2px;border-radius: 2px;margin-top:10px;">' + _(hstask_text) + ' ' + Math.abs(hstaskper) + '% ' + _('from') + ' ' + format_time_hr_min(prv_wk_tot_hr_spent) + '</div><div style="color:#666666;margin-top:3px;">' + _('Last Week to Date') + '</div>';
            ...
            // Storage Data 
            var storageusage = '<div style="width:130px;background:' + storage_color + ';padding:4px;color:#FFFFFF;font-size:11px;margin:0 auto;-moz-border-radius: 2px;border-radius: 2px;margin-top:10px;">' + _(storage_text) + ' ' + Math.abs(storageper) + '% ' + _('from') + ' ' + prev_wk_storage_usage + ' Mb</div><div style="color:#666666;margin-top:3px;">' + _('Last Week to Date') + '</div>';
            ...
            var closedtasks = '<div style="width:120px;background:' + ctask_color + ';padding:4px;color:#FFFFFF;font-size:11px;margin:0 auto;-moz-border-radius: 2px;border-radius: 2px;margin-top:10px;">' + _(ctask_text) + ' ' + Math.abs(ctaskper) + '% ' + _('from') + ' ' + prev_wk_closed_tasks + '</div><div style="color:#666666;margin-top:3px;">' + _('Last Week to Date') + '</div>';
            $('#task_closed').show();
            ...
            var taskupdated = '<div style="width:120px;background:' + task_upd_color + ';padding:4px;color:#FFFFFF;font-size:11px;margin:0 auto;-moz-border-radius: 2px;border-radius: 2px;margin-top:10px;">' + _(task_upd_text) + ' ' + Math.abs(taskupdper) + '% ' + _('from') + ' ' + total_task_upd_prv_week + '</div><div style="color:#666666;margin-top:3px;">' + _('Last Week to Date') + '</div>';
            $('#task_update').show();
...
//	Task Created 
            ...
            var taskcreated = '<div style="width:120px;background:' + task_color + ';padding:4px;color:#FFFFFF;font-size:11px;margin:0 auto;-moz-border-radius: 2px;border-radius: 2px;margin-top:10px;">' + _(task_text) + ' ' + Math.abs(taskper) + '%  ' + _('from') + ' ' + total_task_cr_prv_week + '</div><div style="color:#666666;margin-top:3px;">	' + _('Last Week to Date') + '</div>';
            $('#task_created').show();
