...
<div class="tab tab_comon">
    <ul class="nav-tabs">
        ...
        <li <?php if(PAGE_NAME == 'date_time_view') {?>class="active" <?php }?>>
            <a href="<?php echo HTTP_ROOT.'users/date_time_view';?>" id="sett_mail_repo_prof" rel="tooltip" title="<?php echo __("Default View"); ?>" >
                <div class="fl sett_mail_repo"></div>
                <div class="fl ellipsis-view maxWidth120"><?php echo __("Date-Time Setting"); ?></div>
                <div class="cbt"></div>
            </a>
        </li>
