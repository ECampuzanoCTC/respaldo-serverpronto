...
<script type="text/javascript">
    ...
    var TIMEFORMAT = '<?php echo $GLOBALS['TimeFormat']; ?>';
    var DATEFORMAT = '<?php echo $GLOBALS['DateFormat']; ?>';
...
<?php } ?>
    ...
    var GINV = <?php echo GINV; ?>;
    var EXP = <?php echo EXP; ?>;
    var PROFILE_DTTM = '<?php echo PROFILE_DTTM; ?>';
    var WIKI = <?php echo WIKI; ?>;
...
<?php if (defined('NODEJS_HOST') && trim(NODEJS_HOST)) { ?>
    ...
    <?php if (defined('CHAT') && CHAT == 1) { ?>
                ...
                try {
                    ...
                    chat_client.on('iotoclientlogout', function (data) {
                        console.log(data);
                        showOnlines();
                    });
...
<script type="text/javascript" src="<?php echo JS_PATH; ?>highstock.js"></script>
<?php /* <script type="text/javascript" src="<?php echo JS_PATH; ?>highcharts.js"></script> */ ?>
...
<style>
    ...
    .checkInnerHeight{height:100%}
    .success-icons{background:url(<?php echo HTTP_ROOT; ?>img/succ-msg.png) no-repeat 0px 0px;  bottom: 0;
                   display: block;
                   height: 18px;
                   left: 18px;
                   margin: auto;
                   ...
                   width: 18px;}
    .error-icons{background:url(<?php echo HTTP_ROOT; ?>img/err-msg.png) no-repeat 0px 0px;  bottom: 0;
                 display: block;
                 height: 18px;
                 left: 18px;
                 margin: auto;
    ...
    <div id="topmostdiv">
        ...
        <div class="comn_message_div">
            <div class="comn_message_div_ctnir comn_message_div">		
            </div>
            <script>showTopErrSucc('success', "<?php echo $success; ?>");
        setTimeout('removeMsg()', 6000);</script>
            <?php
            } elseif ($error) {
                ...
                <div class="comn_message_div">
                    ...
                    <script>showTopErrSucc('error', "<?php echo $error; ?>");
                            setTimeout('removeMsg()', 6000);</script>
    <?php }
} else {
    ?>
