...
<table cellpadding="0" cellspacing="0" class="col-lg-12 ad_prj_usr_tbl ad_prj_usr_ipad">
	...
	<div class="scrl-ovr">
		...
		<tr class="hdr_tr">
		    ...
		    <th style="padding-left:10px;"><?php echo __("Name"); ?></th>
		...
		if ($prj_count) {
			...
			<?php
			    ...
			    ?>
			    		<tr>
			    		    <td colspan="3">
			    		<center class="fnt_clr_rd"><?php echo __("No project(s) available."); ?></center>
			    	</td>
				</tr>
			    <?php
			}
	...
	<td valign="top" style="padding-left:10px">
	    ...
	    <table cellpadding="0" cellspacing="0" class="col-lg-12 ad_prj_usr_ipad">
		<tr class="hdr_tr">
		    <th style="padding-left:10px;background: none repeat scroll 0 0 #ABBAC3;color: #FFFFFF;"><?php echo __("Assigned Project(s)"); ?></th>
		</tr>
		<?php
		$count = 0;
		$class = "";
