...
<div class=" task_lis_page">
    <div class="task_listing">
                ...
                <table id="grid-keep-selection" class="table table-condensed table-hover table-striped m-list-tbl">
                    <thead>
                        <tr>
                            ...
                            <th class="tophead manage-list-th2 order-column">User Name</th>
                            <th class="text-center tophead manage-list-th3 order-column">Email</th>
                            <th class="text-center tophead manage-list-th4">Projects</th>
                            <th class="text-center text-center text-center tophead manage-list-th5" >Total Project(s)</th>
                            <th class="text-center tophead manage-list-th6 order-column">User Type</th>
                            <th class="text-center tophead manage-list-th7 order-column">Designation</th>
                           <?php /*  <th class="text-center tophead manage-list-th8 order-column">Start<br />Date</th>
                            ...
                            <th class="text-center tophead manage-list-th14">Last Activity</th>
                        </tr>
                    </thead>
                    <?php
                    //}
        ...
        <?php } ?>
                                ...
                                <td class="text-center" title="<?php echo $user['User']['email'] ; ?>" ><?php $email = $this->Format->shortLength($user['User']['email'],25);
					echo $email; ?></td>
