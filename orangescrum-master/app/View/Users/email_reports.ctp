<div class="user_profile_con email_rpt">
    ...
    <table cellspacing="0" cellpadding="0" class="email_mgt">
        ...
        <tbody>
            ...
            <tr>
                <th class="last"><?php echo __("Task Reminder"); ?>:</th>
                <td class="last">
                    <input type="radio" name="data[UserNotification][case_reminder]" id="remyes" value="1" <?php if(@$getAllNot['UserNotification']['case_reminder'] == 1) {
                        echo 'checked="checked"';
                           } ?> /><?php echo __("Yes"); ?>
                    <input type="radio" name="data[UserNotification][case_reminder]" id="remno" value="0" <?php if(@$getAllNot['UserNotification']['case_reminder'] == 0) {
                        echo 'checked="checked"';
                           } ?> /><?php echo __("No"); ?>
                </td>
            </tr>
