...
<table cellspacing="0" cellpadding="0" class="col-lg-5" style="text-align:left;">
    <tbody>
        ...
        <?php  if((defined('GTLG') && GTLG == 1 || defined('DBRD') && DBRD == 1)){?>
         <tr>
            <th><?php echo __("Work Hour per Day"); ?>:</th>
            <td>
				<?php echo $this->Form->input('work_hour',array('type' => 'number', 'div' => false, 'label' => false, 'min' => 0, 'max' => 24, 'step' => '1', 'value'=>$getCompany['Company']['work_hour'],'class'=>'fl form-control','id'=>'cmpwrkhr', 'maxlength' => 2, 'autocomplete'=>'off')); ?>
			</td>
        </tr>
         <tr>
            <th><?php echo __("Work Days per Week"); ?>:</th>
            <td>
				<?php echo $this->Form->input('work_days',array('type' => 'number', 'div' => false, 'label' => false, 'min' => 1, 'max' => 7, 'step' => '1', 'value'=>$getCompany['Company']['work_days'],'class'=>'fl form-control','id'=>'cmpwrkdys', 'maxlength' => 2, 'autocomplete'=>'off')); ?>
			</td>
        </tr>
        <?php } ?>
