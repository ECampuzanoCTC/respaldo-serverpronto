...
<?php
					...
					<div style="margin-top:20px;padding:5px;">
						...
						<div style="float:left"><a href="https://www.orangescrum.com/how-it-works" target="_blank" style="margin-left:0"><?php echo __("How it Works?"); ?></a></div>
						<div style="float:right;"><a href="https://www.orangescrum.com/help" target="_blank"><?php echo __("Help!"); ?></a></div>
                        <div class="cb"></div>
					</div>
					<?php
					}
					   ...
					   <div style="text-align:center;">
						...
						?>
                                            ...
                                            if($findCompany['Company']['id']) {
                                             ?>
                                            <div>
                                                <div class="os-start-loginbtn">
                                                    <input type="hidden" value="" name="case_details" id="case_details" />
                                                    <button type="submit" value="Save" name="submit_Pass" id="submit_Pass" class="btn btn_blue"><?php echo __("Login"); ?></button> <!--Or &nbsp;-->
                                                ...
                                                <div class="gap10"></div>
                                                <div class="fl">
                                                    <input type="checkbox" name="data[User][remember_me]" id="chk_Rem" class="auto" value="1" style="cursor:pointer; border:none;vertical-align:middle"/>
                                                    <span class="rem_posn" style="color:#666;vertical-align:middle"><?php echo __("Remember me"); ?></span>
                                                </div>
