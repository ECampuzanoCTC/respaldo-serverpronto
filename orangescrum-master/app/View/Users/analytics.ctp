	...
	<div class="tab tab_comon">
	    ...
	    <li id="task_li" class="active">
               <a href="javascript:void(0);">
                <div class="ctab_sprt_icon an_bug fl"></div>
            ...
            <li id="file_li">
                ...
                <div class="cmn_dsb">Hour Spent</div>
                <div class="cbt"></div>
                </a>
            </li>
            <li id="task_li">
                ...
                <div class="cmn_dsb">Task Reports</div>
                <div class="cbt"></div>
                </a>
            </li>
            <li id="task_li">
                <a href="javascript:void(0);" onclick="filterUserRole('disable');">
                <div class="ctab_sprt_icon an_week cmn_dsb"></div>
                <div class="cmn_dsb">Weekly Usage</div>
                <div class="cbt"></div>
                </a>
            </li>			
            <div class="cbt"></div>
