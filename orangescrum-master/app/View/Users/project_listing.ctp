...
<div class="scrl-ovr">
	...
	<tr id="listing<?php echo $cscount; ?>" class="tr_all rw-cls <?php echo $class; ?>">
		...
		<?php if($prj_lst['project_users']['default_email']==0){ ?>
	    	    <ul class="onoff">
			<li class="off"><a href="javascript:void(0)" onclick="setemail(this,'off','<?php echo $prj_lst['project_users']['id'] ?>','on');"><?php echo __("OFF"); ?></a></li>
			<li><a href="javascript:void(0)" onclick="setemail(this,'on','<?php echo $prj_lst['project_users']['id'] ?>','off');"><?php echo __("ON"); ?></a></li>
		    </ul>
		<?php } else { ?>
		    <ul class="onoff">
			<li><a href="javascript:void(0)" onclick="setemail(this,'off','<?php echo $prj_lst['project_users']['id'] ?>','on');"><?php echo __("OFF"); ?></a></li>
			<li class="on"><a href="javascript:void(0)" onclick="setemail(this,'on','<?php echo $prj_lst['project_users']['id'] ?>','off');"><?php echo __("ON"); ?></a></li>
		    </ul>
		<?php } ?>   
	    </td>
	    <?php } ?>
...
<?php } else { ?>
    <center class="fnt_clr_rd"><?php echo __("No project(s) assigned"); ?></center>
