...
<table cellpadding="0" cellspacing="0" class="col-lg-12 new_auto_tab">
 ...
 <div style="padding-left:124px;"> 
		...
		?>
    	    ...
    	    <br/>
    	    <font color="#F05A14"><a href="<?php echo HTTP_ROOT; ?>pricing">Upgrade</a> <?php echo __("your account to create more users"); ?></font>
		<?php
		...
		<button class="btn btn_grey reset_btn" type="button" name="cancel" onclick="closePopup();" ><i class="icon-big-cross"></i><?php echo __("Cancel"); ?></button>
	    </span>
		<?php
	    }
	    ?>
