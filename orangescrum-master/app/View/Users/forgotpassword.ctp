...
<div class="top_m_cont_land">
    <div id="wrapper" class="wrapper_new" style="margin-top:50px">
        	...
        	<div style="position:relative">
                ...
                <div class="login_box">
                    <div class="login_dialog" id="login_dialog">
                        ...
                        <table border="0" align="center" cellpadding="0" cellspacing="0" style="width:100%;table-layout:fixed">
                            <tr>
                                <td>
                                        ...
                                        <table cellspacing="0" cellpadding="0" border="0" width="100%" style="table-layout:fixed">
                                            <tr>
                                                <td style="width:100%; vertical-align:middle">
                                                    ...
                                                    <div><img src="<?php echo HTTP_ROOT; ?>img/images/login_header_shadow.png?v=<?php echo RELEASE; ?>" width="" height="8" style="width:100%;"/></div>
                                                </td>
                                            </tr> 
                                            <tr>
                                              <td>
                                              	<h6 style="margin-left:0;margin-right:0;"><?php echo __("To reset your password, type the full email address you use to sign in to your Orangescrum Account."); ?></h6>
                                              </td>
                                            </tr>
                                                <td align="center">
                                                ...
                                                <td align="left">
                                                    ...
                                                    <div id="fgpass">
                                                        <div class="fl" style=" margin-top:10px;">
                                                            <button type="submit" value="Submit" name="submit_pwd"class="btn btn_blue" style="cursor:pointer;display:inline-block;margin-right:10px"><?php echo __("Submit"); ?></button>
                                                            <span class="or_cancel" style="vertical-align: middle;"><?php echo __("or"); ?><a href="<?php echo HTTP_ROOT; ?>users/login" style="display:inline-block;margin-left:10px;"><?php echo __("Cancel"); ?></a></span>
                                                        </div>
                                                        <div class="cb"></div>
                                                    </div>
                                                    <div class="cb"></div>
                                                    ...
                                                    (<?php echo __("After submitting please click on the link sent to your email"); ?>)
                                                    </h6>
                                    ...
                                    <?php echo $this->Form->create('User',array('url'=>'/users/forgotpassword','onsubmit'=>'return validatepass()')); ?>
                                        ...
                                        <button type="submit" value="Submit" name="submit_pwd" class="btn btn_blue" style="cursor:pointer"><?php echo __("Submit"); ?></button>
                                        <span class="or_cancel"><?php echo __("or"); ?><a href="<?php echo HTTP_ROOT; ?>users/login"><?php echo __("Cancel"); ?></a></span>
                                        </span>
                                    ...
                                    <?php if($chkemail=="10"){?>
                                        ...
                                        <tr>
											<td>
											<div style=" margin-top:0px; margin-bottom:10px"><h2 style="color:#379B37; font-size:20px;"><?php echo __("Your Password is successfully changed."); ?><h3></div>
											<div><img src="<?php echo HTTP_ROOT; ?>img/images/login_header_shadow.png?v=<?php echo RELEASE; ?>"></div>
											</td>
											</tr>
											<tr>
											<td>
	<h2 style="color:#000; font-size:20px;"><a href="<?php echo HTTP_ROOT;?>users/login" style="color:blue;text-decoration:underline;"><?php echo __("Login"); ?></a> <?php echo __("with your new pasword"); ?></a></h2>
											</span>
											</td>
                                        </tr>
...
function validpwd(txtEmail)
{
	...
	if(email.trim() == "")
	{
		err = '<?php echo __("Please enter your email."); ?>';
		done = 0;
	}
	else
	{
		...
		{
			err = '<?php echo __("Invalid 'E-mail' address!"); ?>'
			done = 0;
		}
	}
	if(done == 0)
...
{	
	...
	{
		errMsg = '<?php echo __("Password cannot be  blank!"); ?>'
		newpass.focus();
		done = 0;
	}
	else if(newpass.value.length < 6 || newpass.value.length > 15)
	{
		errMsg = '<?php echo __("Password should be between 6-15 characters!"); ?>'
		newpass.focus();
		done = 0;
	}
	else if(repass.value.trim() == "")
	{
		errMsg = '<?php echo __("Re-Type Password cannot be  blank!"); ?>'
		repass.focus();
		done = 0;
	}
	else if(repass.value != newpass.value)
	{
		errMsg = '<?php echo __("Passwords do not match!"); ?>'
		repass.focus();
		done = 0;
	}
	if(done == 0)
