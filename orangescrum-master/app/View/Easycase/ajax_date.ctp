<li>
	...
	<font onClick="checkBox('date_any');checkboxDate('any','text');filterRequest('time');" >&nbsp;<?php echo __("Anytime"); ?></font>
    </a>
</li>
...
<li>
	...
	<font onClick="checkBox('date_one');checkboxDate('one','text');filterRequest('time');" >&nbsp;<?php echo __("Past hour"); ?></font>
    </a>
</li>
<li>
    <a href="javascript:void(0);">
	...
	<font onClick="checkBox('date_24');checkboxDate('24','text');filterRequest('time');" >&nbsp;<?php echo __("Past 24 hours"); ?></font>
    </a>
</li>
<li>
    <a href="javascript:void(0);">
	...
	<font onClick="checkBox('date_week');checkboxDate('week','text');filterRequest('time');">&nbsp;<?php echo __("Past week"); ?></font>
    </a>
</li>
<li>
    <a href="javascript:void(0);">
	...
	<font onClick="checkBox('date_month');checkboxDate('month','text');filterRequest('time');" >&nbsp;<?php echo __("Past month"); ?></font>
    </a>
</li>
<li>
    <a href="javascript:void(0);">
	...
	<font onClick="checkBox('date_year');checkboxDate('year','text');filterRequest('time');" >&nbsp;<?php echo __("Past year"); ?></font>
    </a>
</li>
...
<div id="custom_date" <?php if(!$dt){?>style="display:none;"<?php }?> >
	<div  class="cdate_div_cls">
		<input type="text" id="frm"  value='<?php echo @$dt['0'];?>' placeholder="<?php echo __('From'); ?>" class="form-control"/><br/>
		<input type="text" id="to" value='<?php echo @$dt['1'];?>' placeholder="<?php echo __('To'); ?>" class="form-control"/>
	</div>
	<div  class="cdate_btn_div" style="text-align:center;margin-top: 5px;cursor:pointer">
		<button class="btn btn-primary cdate_btn"  onclick="checkboxrange('custom_range','text');"><?php echo __("Search"); ?></button>
	</div>
</div>
<script>
$(function() {
