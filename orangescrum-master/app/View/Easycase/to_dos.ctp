...
$gmdate = $this->Tmzone->GetDateTime(SES_TIMEZONE, TZ_GMT, TZ_DST, TZ_CODE, GMT_DATE, "date");
	...
	<div class="due_task_list up_task_list"><?php echo __("Upcoming Tasks"); ?></div>
	<?php } ?>
	...
	<div class="listdv">
		...
		<div class="fl" style="font-size:12px;">
			<span style="color: #999999;"><?php echo __("Created on"); ?> <?php echo $actual_dt_created; ?></span>
		</div>
	    <?php if($due_date) {?>
		<div class="fr" style="font-size:12px;">
		    <div class="img-cls-dt" style="margin:-1px;"></div>
		    <?php if($is_overdue) {?>
			<span class="over-due" title="<?php echo $due_date;?>"><?php echo __("Overdue"); ?></span>
		    <?php } else {?>
	...
	<div class="mytask_txt"><?php echo __("No tasks assigned to you, Explore cool features"); ?>!</div>
