...
if(isset($typeArr))
{
	...
	<div class="slide_menu_div1 more-hide-div">
		<div class="more" align="right" id="type_more">
			<a href="javascript:jsVoid();" onClick="moreLeftNav('type_more','type_hide','<?php echo $h; ?>','hidType_')"><?php echo __("more"); ?>...</a>
		</div>
		<div class="more" align="right" style="display:none;" id="type_hide">
			<a href="javascript:jsVoid();" onClick="hideLeftNav('type_more','type_hide','<?php echo $h; ?>','hidType_')"><?php echo __("hide"); ?>...</a>
		</div>
	</div>
	<?php
	}
