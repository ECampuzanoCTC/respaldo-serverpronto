...
<div class="page-wrapper task_section" style="text-align:right;" id="filter_section">
    <div  id="filter_div_menu">
        <div class="filters">
<!--		<i class="db-filter-icon fl"></i>
            ...
            <div class="fl task_section case-filter-menu " data-toggle="dropdown" title="<?php echo __('Task Filter'); ?>" onclick="openfilter_popup(0, 'dropdown_menu_all_filters');">
                ...
                <ul class="dropdown-menu" id="dropdown_menu_all_filters" style="position: absolute;">
                    ...
                    <li>
                        <a href="javascript:jsVoid();" title="<?php echo __('Milestone'); ?>" data-toggle="dropdown" onclick="allfiltervalue('milestone');"><?php echo __("Milestone"); ?></a>
                        <div class="dropdown_status" id="dropdown_menu_milestone_div" >
                            <i class="status_arrow_new"></i>
                            <ul class="dropdown-menu" id="dropdown_menu_milestone"></ul>
                        </div>
                    </li>
                </ul>
            </div>
            ...
            <div class="filter_btn_section fl" id="savereset_filter">
                <div style="display:none;" id="savefilter_btn" class="fl"  >
                    <div class="db-filter-save-icon fl" onClick="showSaveFilterNew();" title="Save Filter" rel="tooltip"></div>
                ...
                <div class="fl db-filter-reset-icon" style="display:none;" id="reset_btn" title="<?php echo __('Reset Filters'); ?>" rel="tooltip" onClick="resetForCloseAllFilters('all');"></div>
            </div>
            <div class="fl task_section case-filter-menu taskgroupby-div" data-toggle="dropdown" title="<?php echo __('Task Filter'); ?>" onclick="openfilter_popup(0, 'dropdown_menu_groupby_filters');">
                ...
                <ul class="dropdown-menu" id="dropdown_menu_groupby_filters" style="position: absolute;">
                    ...
                    <li id="proGroupId" style='display: none'>
                        <a href="javascript:jsVoid();" title="<?php echo __('Project'); ?>" data-toggle="dropdown" onclick="groupby('project');"><?php echo __("Project"); ?></a>
                    </li>
                    <li>
                        <a href="javascript:jsVoid();" title="<?php echo __('Milestone'); ?>" data-toggle="dropdown" onclick="groupby('milestone');"><?php echo __("Milestone"); ?></a>
                    </li>
                </ul>
            </div>
...
<div class="media-overflow ovr_task_container">
                ...
                <div style="display:block;border:0px solid #FF0000;" class="tab" id="topactions">
                    <ul id="myTab4" class="nav-tabs">
                        ...
                        if (ACT_TAB_ID && ACT_TAB_ID > 1) {
                            ...
                            foreach ($tablists AS $tabkey => $tabvalue) {
                                if ($tabkey & ACT_TAB_ID) {
                                    ...
                                    <li class="<?php echo $default_actv; ?>">
                                        <a class="cattab"  id="<?php echo $tabvalue["fkeyword"]; ?>_id" onclick="caseMenuFileter('<?php echo $tabvalue["fkeyword"]; ?>', 'dashboard', 'cases', '');resetAllFilters('all');" data-toggle="tab" title="<?php print $tabvalue["ftext"]; ?>">
                            ...
                            <?php } ?>
                            <?php
                            if (!empty($newSearchData)) {
                                foreach ($newSearchData as $skey => $sval) {
                                    ?>
                                    <li id ="filterSearch_id<?php echo $skey; ?>"> 
                                        <a class="cattab"  id="ftopt<?php echo $skey; ?>" data-val="<?php echo $skey; ?>" onclick="setSavedFilter(this);caseMenuFileter('<?php echo $skey; ?>', 'dashboard', '<?php echo $skey; ?>', '');resetAllFilters('all');" data-toggle="tab" title="<?php echo $sval; ?>">
                                            <div class="fl<?php echo $skey; ?>"></div>
                                            <div class="fl"><div class="fl ellipsis-view maxWidth90"  id ='custId'><?php echo $sval; ?></div><span class="fl" id="tskTabOverdueCnt_<?php echo $skey; ?>"></span></div>
                                            <div class="cbt"></div>
                                        </a>
                                    </li>
                                    <?php
                ...
                <ul class="nav-tabs mod_wide">
                    <li class="active" id="mlstab_act_kanban">
                        <a href="javascript:void(0);" onclick="showMilestoneList('', 1)" >
                            <div class="act_milestone"></div>
                            <div class=""><?php echo __("Active"); ?></div>
                            <div class="cbt"></div>
                        </a>
                    </li>
                    <li id="mlstab_cmpl_kanban">
                        <a href="javascript:void(0);" onclick="showMilestoneList('', 0)" id="completed_tab" >
                            <div class="mt_completed"></div>
                            <div class=""><?php echo __("Completed"); ?></div>
                            <div class="cbt"></div>
                        </a>
                    </li>
                    <div class="cbt"></div>
...
<input type="hidden" name="caseMilestone" id="caseMilestone1" value="<?php echo $caseMilestone1; ?>" size="4" readonly="true"/>
<input type="hidden" name="caseProject" id="caseProject" value="<?php echo $caseProject; ?>" size="4" readonly="true"/>
...
<input type="hidden" id="countFilter"  value="">
