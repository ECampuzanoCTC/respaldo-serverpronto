...
<ul class="sortable" id="ul_mydashboard">
	...
	<div class="sort_li_inner">
	    <div class="dshbd-hed">
		<div class="fl"><?php echo __($value['name'], true);?></div>
		<div class="fr active_icn portlet-header">
		    <img width="16px" src="<?php echo HTTP_IMAGES; ?>images/active_dboard.png" rel="tooltip" title="<?php echo __("Move"); ?>"/>
		</div>
		...
		<div class="fr active_icn">
			<a href="javascript:void(0);" onclick="creatask()" class="" style="color:#5191BD; font-size:13px;display:block;" rel="tooltip" title="<?php echo __("Create Task"); ?>">
    ...
    <li class="sortable-li" id="list_<?php echo $value['id'];?>">
		...
		<?php if(defined('CR') && CR == 1 && SES_CLIENT ==1 && $this->Format->get_client_permission('user')==1){ 
                    /**Not Show create project */
                }else{?> 		
                <div class="fr active_icn">
					<a href="javascript:void(0);" onclick="newUser()" class="" style="color:#5191BD; font-size:13px;" rel="tooltip" title="<?php echo __("Invite User"); ?>">
						<i class="icon-create-proj"></i>
					</a>
				</div>
                <?php } ?>
	    	...
	    	<div class="htdb custom_scroll">
				<div class="loader_dv_db" id="recent_activities_ldr" style="display: none;margin-top: 90px;"><center><img src="<?php echo HTTP_IMAGES; ?>images/case_loader2.gif" alt="Loading..." title="<?php echo __("Loading"); ?>..." /></center></div>
    ...
    <li class="sortable-li" id="list_<?php echo $value['id'];?>">
        <div class="sort_li_inner">
            ...
            <div class="loader_dv_db" id="usage_details_ldr" style="display: none;margin-top: 90px;"><center><img src="<?php echo HTTP_IMAGES; ?>images/case_loader2.gif" alt="Loading..." title="<?php echo __("Loading"); ?>..." /></center></div>
        </div>
    </li>
	...
	<div class="sort_li_inner">
		...
		<div class="fl">
			...
			<option value="<?php echo $value['Type']['id']; ?>" <?php if (isset($_COOKIE['TASK_TYPE_IN_DASHBOARD']) && $_COOKIE['TASK_TYPE_IN_DASHBOARD']==$value['Type']['id']){echo "selected='selected'";}?>><?php echo __($value['Type']['name'], true); ?></option>
		    <?php }?>
		    </select>
		</div>
		<div class="fl pichart_msg ellipsis-view" id="task_type_msg" style="font-size: 15px;max-width:120px;"></div>
		<div class="fr active_icn portlet-header">
		    <img width="16px" src="<?php echo HTTP_IMAGES; ?>images/active_dboard.png" rel="tooltip" title="<?php echo __("Move"); ?>"/>
		</div>
		<div class="cb"></div>
	    ...
	    <div class="loader_dv_db" id="task_type_ldr" style="display: none;margin-top: 90px;"><center><img src="<?php echo HTTP_IMAGES; ?>images/case_loader2.gif" alt="Loading..." title="<?php echo __("Loading"); ?>..." /></center></div>
	</div>
    </li>
    ...
    <li class="sortable-li" id="list_<?php echo $value['id'];?>">
        <div class="sort_li_inner">
            ...
            <div class="loader_dv_db" id="task_status_ldr" style="display: none;margin-top: 90px;"><center><img src="<?php echo HTTP_IMAGES; ?>images/case_loader2.gif" alt="Loading..." title="<?php echo __("Loading"); ?>..." /></center></div>
        </div>
    </li>
    <?php } elseif($value['name'] == 'Time Log'){ ?>
    <li class="sortable-li tlog-grph" id="list_<?php echo $value['id']; ?>">
        <div class="sort_li_inner">
            <div class="dshbd-hed">
                <div class="fl"><?php echo __($value['name'], true); ?></div>
                <div class="fr active_icn portlet-header">
            ...
            <div id="timelog_graph" class="dboard_cont"></div>
            <div class="loader_dv_db" id="timelog_graph_ldr" style="display:none;margin-top: 90px"><center><img src="<?php echo HTTP_IMAGES; ?>images/case_loader2.gif" alt="Loading..." title="<?php echo __("Loading"); ?>..." /></center></div>
        </div>
    </li>
    <?php }
    }
