...
<table cellpadding="0" cellspacing="0" class="col-lg-12 new_auto_tab">
	...
	<td>
	    ...
	    <div id="err_msg_dv" class="exist-prj"><?php echo __("Already in this Project."); ?></div>
	</td>
    </tr>
    ...
    <?php } else { ?>
    <tr>
	<td class="v-top" colspan="2"><span class="fnt_clr_rd"><?php echo __("No Projects assigned yet!"); ?></span></td>
    </tr>
    <?php } ?>
    <tr>
	<td class="v-top">&nbsp;</td>
	<td style="text-align:left;">
	    ...
	    <span id="mvprj_btn">
		<button class="btn btn_blue" id="mvbtn"  value="Move" type="button" onclick="moveTaskToProject();"><i class="icon-big-tick"></i><?php echo __("Move"); ?></button>
