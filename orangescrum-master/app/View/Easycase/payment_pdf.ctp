            ...
            <div class="invo-cont1">
                ...
                <div class="fr invo-rht-cont1">
                    <div class="invo-hd">
                        <h1><a >Payment</a></h1>
                        <div class="invo-dt">
                            <div class="fl invo-lft-dt">Payment#</div>
                            <div class="fl invo-rht-dt">:&nbsp;&nbsp;<?php print $i['Payment']['payment_no']; ?></div>
                            <div class="cb"></div>
                        </div>
                        <?php /*
                        <div class="invo-dt">
                        ...
                        <div class="invo-dt">
                            <div class="fl invo-lft-dt">Generation Date</div>
                            <div class="fl invo-rht-dt">:&nbsp;&nbsp;<?php echo date('M d,Y', strtotime($i['Payment']['issue_date'])); ?></div>
                            <div class="cb"></div>
                        </div>
                        <div class="invo-dt">
                            <div class="fl invo-lft-dt">Received Date</div>
                            <div class="fl invo-rht-dt">:&nbsp;&nbsp;<?php if($i['Payment']['receive_date']){echo date('M d,Y', strtotime($i['Payment']['receive_date'])); } ?></div>
                            <div class="cb"></div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="tol-amount">
                        <table class="inv-summary" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <?php if (floatval($i['Payment']['discount']) > 0) { ?>
                                <tr>
                                    <td>Discount<span class="percent"><?php print ($i['Payment']['discount_type'] != 'Flat') ? '('.$i['Payment']['discount'] . '%)' : ''; ?></span></td>
                                    <td>
                                        <?php
