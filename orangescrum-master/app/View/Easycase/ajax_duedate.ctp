...
<!--<li>
	...
	<font onClick="checkBox('duedate_one');checkboxdueDate('one','text');filterRequest('duedate');" >&nbsp;<?php echo __("Past hour"); ?></font>
    </a>
</li>-->
<li>
    <a href="javascript:void(0);">
...
<!--<li>
	...
	<font onClick="checkBox('duedate_month');checkboxdueDate('month','text');filterRequest('duedate');" >&nbsp;<?php echo __("Next month"); ?></font>
    </a>
</li>
<li>
    <a href="javascript:void(0);">
	...
	<font onClick="checkBox('duedate_year');checkboxdueDate('year','text');filterRequest('duedate');" >&nbsp;<?php echo __("Next year"); ?></font>
    </a>
</li>-->
...
<div id="custom_duedate" <?php if(!$dt){?>style="display:none;"<?php }?> >
	<div  class="cdate_div_cls">
		<input type="text" id="duefrm"  value='<?php echo $duefrm;?>' placeholder="<?php echo __('From'); ?>" class="form-control"/><br/>
		<input type="text" id="dueto" value='<?php echo $dueto;?>' placeholder="<?php echo __('To'); ?>" class="form-control" />
	</div>
