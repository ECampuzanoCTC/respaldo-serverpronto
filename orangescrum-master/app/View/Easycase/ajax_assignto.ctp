...
//echo 'smruti';pr($asnArr);exit;
	...
	<div class="slide_menu_div1 more-hide-div">
		<div class="more" align="right" id="Asn_more" >
			<a href="javascript:jsVoid();" onClick="moreLeftNav('Asn_more','Asn_hide','<?php echo $h; ?>','hidAsn_')"><?php echo __("more..."); ?></a>
		</div>
		<div class="more" align="right" id="Asn_hide" style="display:none;">
			<a href="javascript:jsVoid();" onClick="hideLeftNav('Asn_more','Asn_hide','<?php echo $h; ?>','hidAsn_')"><?php echo __("hide..."); ?></a>
		</div>
	</div>
	<?php
	} ?>
