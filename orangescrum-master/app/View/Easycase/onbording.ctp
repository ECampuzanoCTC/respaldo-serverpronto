...
<div class="steps_os">
	<div class="steps_usr">
		<h1 style="color: #428BCA;"><?php echo __("Welcome"); ?> <?php echo USERNAME; ?>!<br/> <?php echo __("Get started with your Orangescrum account"); ?></h1>
		<h6 style="color: #D67866;font-size: 17px;"><?php echo __("You're just 3 simple steps away from exploring Orangescrum!"); ?></h6>
	</div>
				...
				<table class="onbrd_lt_tbl">
					<tr>
						...
						<td class="<?php if($is_active_proj){?>inactive_ttl<?php }else{?>active_ttl <?php }?>">
							<h4 style="padding-top:0;margin-top:0;"><a href="javascript:void(0);" onclick="newProject('menupj','loaderpj');" class="crt-asn-task"><?php echo __("Create and Assign Project"); ?></a></h4>
							<div class="det_text">
								<ul style="list-style: square;">
									<li><?php echo __("Name your project suitably and select a matching short name."); ?></li>
									<li><?php echo __("You as an admin will be automatically assigned the project created above"); ?></li>
								</ul>
							</div>
						</td>
					</tr>
					<tr>
						...
						<td class="<?php if($totalusers>1){?>inactive_ttl<?php }else{?>active_ttl <?php }?>">
							<h4 style="padding-top:0;margin-top:0;"><a href="javascript:void(0);" <?php if(ACCOUNT_STATUS!=2){?> onclick="newUser('menuid1','loaderid1');" <?php }?>><?php echo __("Invite User"); ?></a></div></h4>
							<div class="det_text">
								<ul style="list-style: square;">
									<li><?php echo __("Send invitation to co-workers for the project"); ?></li>
									<li><?php echo __("Users need to setup their account by using the invitation email"); ?></li>
									<li><?php echo __("Then, Admin can add them up to the project"); ?></li>
								</ul>
							</div>
						</td>
					</tr>
...
<!--						<th>
					...
					<tr>
						...
						<td class="<?php if(isset($task_crted) && $task_crted>=1){?>inactive_ttl<?php }else{?>active_ttl <?php }?>">
							<div id="CreateTaskWithoutLnk" >
								<h4 style="padding-top:0;margin-top:0;"><div class="fl" style="width: 140px;"><a href="javascript:void(0);" <?php if($is_active_proj){?> onclick="creatask();" class="crt-asn-task" <?php }else{?>style="cursor: default;text-decoration:none;color:#666666" <?php } ?>><?php echo __("Create Task"); ?></a></div>
								<div class="fl" style="width: 35px;">or</div>
								<div class="fl" style="width: 140px; "><a href="<?php if($is_active_proj){ echo HTTP_ROOT;?>projects/importexport<?php }else{echo 'javascript:void(0);';}?>" <?php if($is_active_proj){?> class="crt-asn-task" <?php }else{?>style="cursor: default;text-decoration:none;color:#666666" <?php }?>><?php echo __("Import Task"); ?></a></div></h4>
								<div class="cb"></div>
							</div>
							...
							<div class="det_text">
								<ul style="list-style: square;">
									<li><?php echo __("You can create task under a project"); ?></li>
									<li><?php echo __("Select title, put due date, set priority"); ?></li>
									<li><?php echo __("Assign the task to resource"); ?></li>
								</ul>
							</div>
						</td>
					</tr>
			...
			<td class="onbrd_rt">
				<div class="steps_progbar" style="padding-top: 0px;margin-top:0px; ">
					...
					<h6 style="text-align:center"><?php echo $comp_steps;?> <?php echo __("of 3 Steps Completed"); ?></h6>
				</div>
				<div style="padding-top:0px;text-align:center">
				<?php if(!$is_active_proj){?>					
				<h4 style="text-shadow:none; font-size: 26px;text-align:center"><?php echo __("Create your first project, and get started"); ?><br/></h4>
					<div class="on_brd_blue" <?php if(ACCOUNT_STATUS!=2){?> onclick="newProject('menupj','loaderpj');" <?php }?>>
						...
						<a href="javascript:void(0);"  style="text-decoration: none;color: #fff; font-weight: bold;" ><?php echo __("Create Project"); ?></a> 			
					</div>
				<?php }elseif($totalusers<=1){?>
					<h4 style="text-shadow:none; font-size: 26px;text-align:center"><?php echo __("Looks like it's just you in here"); ?><br/>
					Orangescrum <?php echo __("works best when you add your Co-workers."); ?></h4>
				<div class="on_brd_blue" <?php if(ACCOUNT_STATUS!=2){?> onclick="newUser('menuid1','loaderid1');" <?php }?>>					
					<img src="<?php echo HTTP_ROOT;?>img/wright_icon.png" />
					<a href="javascript:void(0);"  style="text-decoration: none;color: #fff; font-weight: bold;" > <?php echo __("Invite User"); ?></a>
				</div>
				...
				<?php }*/elseif((!isset($task_crted)) || ($task_crted==0)){ ?>
						<h4 style="text-shadow:none; font-size: 26px;text-align:center"><?php echo __("Final step, Create Task and assign, Boom!"); ?></h4>
						<div class="on_brd_blue" onclick="creatask();">
							<img src="<?php echo HTTP_ROOT;?>img/wright_icon.png" />
							<a href="javascript:void(0);"  style="text-decoration: none;color: #fff; font-weight: bold;" ><?php echo __("Create Task"); ?></a>
						</div>
				<?php }else{ $autorefreshflag =1;?>
						<h4 style="text-shadow:none; font-size: 26px;text-align:center"><?php echo __("Wow! You have completed all the basics of"); ?> Orangescrum.<br/>
						<?php echo __("Now you can get started with"); ?> Orangescrum.</h4><br/>
						<h3 style="font-weight:normal">
							<?php echo __("This page will automatically redirect to dashboard within"); ?> <span id="seccnt" style="font-size:18px;font-weight:bold;">10</span> Seconds<br>
							<a href="<?php echo HTTP_ROOT.'dashboard#tasks';?>" style="text-decoration:underline;"><?php echo __("Click here"); ?></a> <?php echo __("to Redirect to the task page."); ?>
						</h3>
				<?php }?>
				</div>
                ...
                <div style="text-align:center;width:100%">
                	<a href="<?php echo HTTP_ROOT."task-type"; ?>" style="color:#00F;text-decoration:underline" target="_blank"><?php echo __("Create your Custom Task Type"); ?> >></a>
                </div>
			</td>
		</tr>
	</table>
...
<table cellspacing="0" cellpadding="0" width="700px" class="div_pop" align="center">
		...
		<td style="padding-left:10px;" valign="middle" class="ms_hd">
			<div style="float:left;padding-top:3px;">
				<table cellpadding="0" cellspacing="0">
					<tr>
						<td>
							<h1 style="margin:0;padding:0;" class="popup_head"><?php echo __("Add User"); ?></font></h1>
						</td>
	...
	<tr>
		<td style="padding:5px 11px;" align="right">
			<span id="usersrch" style="display:none;">
             	<div class="find_prj_ie"><?php echo __("Enter User Name"); ?></div>
	...
	<tr>
		<td align="center">
			...
			<span id="popupload" style="display:none;position:absolute;top:17%;left:40%;"><?php echo __("Loading users"); ?>... <img src="<?php echo HTTP_IMAGES;?>images/del.gif" title="Loading..." alt="Loading..."/></span>
			...
			<td valign="middle" style="width:500px" align="center" class="nwa">
				<span id="confirmbtn" style="display:block;">
					<button class="blue small" id="confirmusercls" style="margin-left:3px;width:75px" value="Confirm" type="button" onclick="assignuser(this)"><?php echo __("Add"); ?></button>
					Or <button class="blue small" id="confirmuserbut" style="margin-left:3px;width:150px" value="Confirm" type="button" onclick="assignuser(this)"><?php echo __("Add & Continue"); ?></button>
					Or <a id="javascript:void(0);" style="font-size:14px;" onclick="fbPopupClose()"><?php echo __("Cancel"); ?></a>
				</span>
				...
				<span id="excptAddContinue" style="display:none;">
					<button class="blue small" id="confirmusercls" style="margin-left:3px;width:75px" value="Confirm" type="button" onclick="assignuser(this)"><?php __("Add"); ?></button>
					<?php echo __("Or"); ?> <a id="javascript:void(0);" style="font-size:14px;" onclick="fbPopupClose()"><?php echo __("Cancel"); ?></a>
				</span>
			</td>
			</tr>
			</table>
