...
<table border="0" style="border:1px solid #CFD7DD" width="100%">
				<tr bgcolor="#CFD7DD" style="font-weight:bold;color:#333333;padding-left:5px;" height="25px"  valign="top">
					<td  style="padding-left:4px;" align="left" width="300px"><?php echo __("Title"); ?></td>
					<td  style="padding-left:4px;" align="left"><?php echo __("Description"); ?></td>                        
					<td  style="padding-left:4px;" align="left" width="80px"><?php echo __("Created Date"); ?></td>
					<td align="center" width="75px"><?php echo __("Action"); ?></td>
				</tr>
				<?php
				$count=0; $clas = "";
				$totCase = 0; 
				...
				<?php 
					...
					?>
					<td colspan="7" align="center">
						<span style="width:100%;text-align:center;font-size:14px;color:#FF0000;list-style:none;height:60px;"><?php echo __("No data available"); ?></span>
					</td>
					<?php
				}
				?>
