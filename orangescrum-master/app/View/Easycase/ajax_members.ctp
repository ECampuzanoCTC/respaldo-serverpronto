...
if(isset($memArr))
{
	...
	<div class="slide_menu_div1 more-hide-div">
		<div class="more" align="right" id="mem_more">
			<a href="javascript:jsVoid();" onClick="moreLeftNav('mem_more','mem_hide','<?php echo $h; ?>','hidMem_')"><?php echo __("more"); ?>...</a>
		</div>
		<div class="more" align="right" id="mem_hide" style="display:none;">
			<a href="javascript:jsVoid();" onClick="hideLeftNav('mem_more','mem_hide','<?php echo $h; ?>','hidMem_')"><?php echo __("hide"); ?>...</a>
		</div>
	</div>
	<?php
	} ?>
