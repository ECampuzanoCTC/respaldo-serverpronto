<div class="install-wrapper">
    <h2 class="welcome">Welcome to OrangeScrum Community version Installation wizard</h2>
    <hr />
<?php 
    if($addon != '' && in_array($addon, array_keys($addonName))){ ?>
    <div class="steps">
        Make sure to copy the downloaded zip file to the "app/webroot" folder before starting installation. Please ignore if it is already done.
    </div>
    <div class="meter orange">
        <span style="width:0%"></span>
    </div>
    <div class="step" id="first_step">
        <p class="valid-nm">Please click on start button to start <?php echo $addonName[$addon]; ?> add-on installation procedure.</p>
    ...
    <div class="step" id="second_step">
        <p class="valid-nm"></p>
        <div class="import_btn_div fl" style="width: 100%;height: 60px;">
            <img src="<?php echo HTTP_IMAGES; ?>images/case_loader2.gif" alt="Loading..." title="Loading..."  id="loader_img_tt1" style="display: none;position: absolute;"/>
    ...
    <div class="step" id="third_step">
        <p class="valid-nm"></p>
        <div class="import_btn_div fl" style="width: 100%;height: 60px;">
            <img src="<?php echo HTTP_IMAGES; ?>images/case_loader2.gif" alt="Loading..." title="Loading..."  id="loader_img_tt2" style="display: none;position: absolute;"/>
    ...
    <div class="step" id="fourth_step">
        <p class="valid-nm"></p>
        <div class="import_btn_div fl" style="width: 100%;height: 60px;">
            <img src="<?php echo HTTP_IMAGES; ?>images/case_loader2.gif" alt="Loading..." title="Loading..."  id="loader_img_tt3" style="display: none;position: absolute;"/>
    ...
    <div class="step" id="fifth_step">
        <p class="valid-nm"></p>
        <div class="import_btn_div fl" style="width: 100%;height: 60px;">
            <img src="<?php echo HTTP_IMAGES; ?>images/case_loader2.gif" alt="Loading..." title="Loading..."  id="loader_img_tt4" style="display: none;position: absolute;"/>
            <button type="button" id="tt_save_btn4" name="tt_save_btn" class="btn btn_blue" onclick="finishAddonInstalled()">
                <i class="icon-big-tick"></i>
                <span style="color: #fff;">Finish</span>
            </button>
        </div>
    </div>
    <?php }else{ ?>
        <h2 class="invalid-nm">Please provide a valid add-on name in the URL as shown in the installation guide to install that add-on.</h2>
        <a href="http://www.orangescrum.org/how-to-install-timelog-addon-in-orangescrum" class="guide-link">Go to Installation guide.</a>
    <?php }
?>
</div>
