...
<div class= "milestonediv" style="display: none;">
...
<script type="text/javascript">
	...
	$("#milestone_dropdown").change(function(){
		...
		showGanttchart(mluniq,'');
	});
    });

    function showGanttchart(mid,pid){
        return false;
        mid = mid==null?'notrequired':mid;
        //console.log(mid);
		$("#eventMessage").text("");
		$("#ganttChart").ganttView({ 
			dataUrl: "/Ganttchart/ganttdata/"+mid+"/"+pid, 
			slideWidth: 870,
			behavior: {
				clickable: true,
				draggable: true,
