<style type="text/css">
    ...
    .margin15{margin-top:15px;margin-left:-5px;}
        ...
        .log-btn{margin:25px 0px 0px 0px;padding:0 30px;height:50px;text-align:left;}
...
<form action="<?php echo HTTP_ROOT."add_tasklog"; ?>" method="POST" onSubmit="return stvariables();" autocomplete="off" name='frmaddlogtim' id="frmaddlogtim">
    ...
    <input type="hidden" name="chked_autos" value="" id="chked_autos" /> 
    ...
    <div class="logtime-content">
        <div style="padding: 20px 30px 0; width: 100%;">
            ...
            <div class="spent-time fr" id="tl-msg-box">
				...
				<div class="fl" style="margin:0 10px 0 0;"><span class="use-time"><?php echo __("Non-Billable");?>: </span><span id='logtime_nonbillable'>---</span></div>
        ...
        <div class="log-time">
                <ul class="timelog-header">
                    <li style="width:25%;"><label><?php echo __('Resource');?></label></li>
                    <li style="width:15%;"><label><?php echo __('Date');?></label></li>
                    <li style="width:15%;"><label><?php echo __('Start Time');?></label></li>
                    <li style="width:15%;"><label><?php echo __('End Time');?></label></li>
                ...
                <ul id="ul_timelog1">
                    ...
                    <li>
                        <div class="margin15" style="margin-left:2px;">
                    ...
                    <?php if(defined('GINV') && GINV == 1) {?>
                    <li>
                        <div class="margin15" style="margin-left:10px">
                            <input type="checkbox" class="autogeneratecls" id="auto_generate1" name="auto_generate[]" value="1" checked="checked" />
                            <span style=""><?php echo __("Auto generate invoice on task close?"); ?></span>
                        </div>
                    </li>
                    <?php } ?>
        ...
        <div style="margin:15px 30px;" id="tasklog">
			...
			<!--<div style="margin:15px 30px;" >
				<span id="existtskid"  style="display:none;"><a href="javascript:void(0);" onclick="showtaskpopup();" style="color:#317599;">Choose a task for current project</a>
			</div>
			 <div class="complete-checkbox" style="margin-left:30px;">
				<input type="checkbox" name="task_status" value="1" >&nbsp;Mark task as closed
				</div> -->
