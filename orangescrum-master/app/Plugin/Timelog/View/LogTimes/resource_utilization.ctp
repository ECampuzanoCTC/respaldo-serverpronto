...
<div class="proj_grids glide_div" id="main_con_task">
    <div class="proj_grids glide_div setting_wrapper task_listing resource_sec cmn_tbl_widspace" id="resource_utilization_div">	
        ...
        <div class="resourceUtilization">
            <div style="margin-bottom:9px;width:100%;"></div>
            <div id="recource_utilization_export_btn" class="logmore-btn btn_tlog_top fr" style="display:none;">
                <a class="btn btn-sm btn_cmn_efect" onclick="ajax_resource_utilization_export_csv();">
                    <span aria-hidden="true" class="glyphicon glyphicon-export"></span> <?php echo __("Export"); ?>(.csv)
                </a>
            </div>
            <div class="fl case-filter-menu " data-toggle="dropdown" rel="tooltip" title="<?php echo __('Filter'); ?>" onclick="openfilter_popup(0, 'dropdown_menu_all_filters');" style="display:none;">
                        ...
                        <div class="dropdown_status" id="dropdown_menu_utilization_div">
                            ...
                            <ul class="dropdown-menu" id="dropdown_menu_utilization">
                                <li><a href="javascript:void(0);">
                                        <input type="checkbox" id="utilization_today" data-id="today" <?php if ($_COOKIE['utilization_date_filter'] == 'today') {
                        echo "checked";
                    } ?> onclick="utilization('today', 'check');" style="cursor:pointer;" />
                                        <font onClick="utilization('today', 'text');" style="cursor:pointer;">
<?php echo __("Today"); ?>
                                        </font></a>
                                </li>
                                <li><a href="javascript:void(0);">
                                        <input type="checkbox" id="utilization_yesterday" data-id="yesterday" <?php if ($_COOKIE['utilization_date_filter'] == 'yesterday') {
    echo "checked";
} ?> onclick="utilization('yesterday', 'check');" style="cursor:pointer;" />
                                        <font onClick="utilization('yesterday', 'text');" style="cursor:pointer;">
                                        &nbsp;<?php echo __("Yesterday"); ?>
                                        </font></a>
                                </li>
                                <li><a href="javascript:void(0);">
                                        <input type="checkbox" id="utilization_thisweek" data-id="thisweek" <?php if ($_COOKIE['utilization_date_filter'] == 'thisweek') {
    echo "checked";
} ?> onclick="utilization('thisweek', 'check');" style="cursor:pointer;" />
                                        <font onClick="utilization('thisweek', 'text');" style="cursor:pointer;">
                                        &nbsp;<?php echo __("This Week"); ?>
                                        </font></a>
                                </li>
                                <li><a href="javascript:void(0);">
                                        <input type="checkbox" id="utilization_thismonth" data-id="thismonth" <?php if ($_COOKIE['utilization_date_filter'] == 'thismonth') {
    echo "checked";
} ?> onclick="utilization('thismonth', 'check');" style="cursor:pointer;" />
                                        <font onClick="utilization('thismonth', 'text');" style="cursor:pointer;">
                                        &nbsp;<?php echo __("This Month"); ?>
                                        </font></a>
                                </li>
                                <li><a href="javascript:void(0);">
                                        <input type="checkbox" id="utilization_thisquarter" data-id="thisquarter" <?php if ($_COOKIE['utilization_date_filter'] == 'thisquarter') {
    echo "checked";
} ?> onclick="utilization('thisquarter', 'check');" style="cursor:pointer;" />
                                        <font onClick="utilization('thisquarter', 'text');" style="cursor:pointer;">
                                        &nbsp;<?php echo __("This Quarter"); ?>
                                        </font></a>
                                </li>
                                <li><a href="javascript:void(0);">
                                        <input type="checkbox" id="utilization_thisyear" data-id="thisyear" <?php if ($_COOKIE['utilization_date_filter'] == 'thisyear') {
    echo "checked";
} ?> onclick="utilization('thisyear', 'check');" style="cursor:pointer;" />
                                        <font onClick="utilization('thisyear', 'text');" style="cursor:pointer;">
                                        &nbsp;<?php echo __("This Year"); ?>
                                        </font></a>
                                </li>
                                <li><a href="javascript:void(0);">
                                        <input type="checkbox" id="utilization_lastweek" data-id="lastweek" <?php if ($_COOKIE['utilization_date_filter'] == 'lastweek') {
    echo "checked";
} ?> onclick="utilization('lastweek', 'check');" style="cursor:pointer;" />
                                        <font onClick="utilization('lastweek', 'text');" style="cursor:pointer;">
                                        &nbsp;<?php echo __("Last Week"); ?>
                                        </font></a>
                                </li>
                                <li><a href="javascript:void(0);">
                                        <input type="checkbox" id="utilization_lastmonth" data-id="lastmonth" <?php if ($_COOKIE['utilization_date_filter'] == 'lastmonth') {
    echo "checked";
} ?> onclick="utilization('lastmonth', 'check');" style="cursor:pointer;" />
                                        <font onClick="utilization('lastmonth', 'text');" style="cursor:pointer;">
                                        &nbsp;<?php echo __("Last Month"); ?>
                                        </font></a>
                                </li>
                                <li><a href="javascript:void(0);">
                                        <input type="checkbox" id="utilization_lastquarter" data-id="lastquarter" <?php if ($_COOKIE['utilization_date_filter'] == 'lastquarter') {
    echo "checked";
} ?> onclick="utilization('lastquarter', 'check');" style="cursor:pointer;" />
                                        <font onClick="utilization('lastquarter', 'text');" style="cursor:pointer;">
                                        &nbsp;<?php echo __("Last Quarter"); ?>
                                        </font></a>
                                </li>
                                <li><a href="javascript:void(0);">
                                        <input type="checkbox" id="utilization_lastyear" data-id="lastyear" <?php if ($_COOKIE['utilization_date_filter'] == 'lastyear') {
    echo "checked";
} ?> onclick="utilization('lastyear', 'check');" style="cursor:pointer;" />
                                        <font onClick="utilization('lastyear', 'text');" style="cursor:pointer;">
                                        &nbsp;<?php echo __("Last year"); ?>
                                        </font></a>
                                </li>
                                <li><a href="javascript:void(0);">
                                        <input type="checkbox" id="utilization_last365days" data-id="last365days" <?php if ($_COOKIE['utilization_date_filter'] == 'last365days') {
    echo "checked";
} ?> onclick="utilization('last365days', 'check');" style="cursor:pointer;" />
                                ...
                                <li>
                                    <a href="javascript:void(0);">
                                        <input type="checkbox" id="utilization_custom" style="cursor:pointer" onclick="customdatetutilization();" <?php if (strpos($_COOKIE['utilization_date_filter'], ':')) {
    echo "checked";
} ?> />
...
<?php $dt = explode(':', $_COOKIE['utilization_date_filter']); ?>
                    ...
                    <li>
                        ...
                        <div class="dropdown_status" id="dropdown_menu_utilization_status_div">
                            <i class="status_arrow_new"></i>
                            <ul class="dropdown-menu" id="dropdown_menu_utilization_status"></ul>
                        </div>
                    </li>
                    <li>
                        <a href="javascript:jsVoid();" title="Project" data-toggle="dropdown" onclick="allfiltervalue('utilization_project', event);"><?php echo __("Project"); ?></a>
                    ...
                    <li>
                        <a href="javascript:jsVoid();" title="Resource" data-toggle="dropdown" onclick="allfiltervalue('utilization_resource', event);"><?php echo __("Resource"); ?></a>
            ...
            <div style="margin-bottom:9px;width:100%;clear:both;"></div>
            <table id="grid-keep-selection" class="table table-striped resource-utilize-table m-list-tbl">
                <thead>
                    <tr>
                        ...
                        <th data-column-id="task_group" data-visible="false"><?php echo __("Milestone"); ?></th>
                        ...
                        <th data-column-id="esthrs"><?php echo __("Estimated Hour(s)"); ?></th>
                        <th data-column-id="is_billable" data-sortable="false"><?php echo __("Billable"); ?></th>
                    </tr>
                </thead>
            </table>
        </div>
...
<style>
    ...
    #dropdown_menu_utilization_status,#dropdown_menu_utilization_project,#dropdown_menu_utilization_resource{max-height: 240px;min-width: 175px;overflow-y: auto;padding-left: 12px;}
</style>
<script>
    ...
    function utilization_status(filter, type) {
        ...
        $('.utilization-status').each(function () {
            ...
            if ($(this).is(':checked')) {
                var stsid = "stsids_" + dt_id;
                var stsvalue = $("#" + stsid).val();
                sts_filter += stsvalue + "-";
            }
        });
