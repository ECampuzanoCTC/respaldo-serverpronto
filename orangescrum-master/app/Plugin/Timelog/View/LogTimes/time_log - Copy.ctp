...
<?php } ?>
<div class="row">
    <div id="resetdiv" class="filter-info col-lg-10">
        <div class="fl"><span><?php echo __('Showing time log');?>:</span><span id="filter_text" class="filter-text">&nbsp;<?php if(!empty($filter_text)){echo $filter_text;}else{echo __("for all users and all dates");} ?></span></div>
...
<?php  if($log['LogTime']['user_id'] == SES_ID || SES_TYPE == 1 || SES_TYPE == 2){ ?>
<td data-logid="<?php echo $log['LogTime']['log_id'];?>">
<?php } else { ?>
...
<div id="calendar_view" class="calendar_section calendar_resp" style="display:none;margin-top: 12px;"></div>
