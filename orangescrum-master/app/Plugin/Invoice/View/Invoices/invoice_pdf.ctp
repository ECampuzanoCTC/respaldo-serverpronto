        ...
        <div class="invoice-content">
            <div class="invo-cont1">
                ...
                <div class="fr invo-rht-cont1">
                    <div class="invo-hd">
                        <h1><a >INVOICE</a></h1>
                        <div class="invo-dt">
                            <div class="fl invo-lft-dt"><?php echo __('Invoice');?>#</div>
                            <div class="fl invo-rht-dt">:&nbsp;&nbsp;<?php print $i['Invoice']['invoice_no']; ?></div>
                            <div class="cb"></div>
                        </div>
                        <div class="invo-dt">
                            <div class="fl invo-lft-dt"><?php echo __('Terms');?></div>
                        ...
                        <div class="invo-dt">
                            <div class="fl invo-lft-dt"><?php echo __('Invoice Date');?></div>
                            <div class="fl invo-rht-dt">:&nbsp;&nbsp;<?php echo date('M d,Y', strtotime($i['Invoice']['issue_date'])); ?></div>
                            <div class="cb"></div>
                        </div>
                        <div class="invo-dt">
                            <div class="fl invo-lft-dt"><?php echo __('Due Date');?></div>
            ...
            <div class="tab-cont">
                <table border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        <th style="<?php if($layout == 'portrait'){?>width:15%;<?php }else{ ?>width:10%;<?php }?>"><?php echo __('Date');?></th>
                        <th style="<?php if($layout == 'portrait'){?>width:40%;<?php }else{ ?>width:50%;<?php }?>"><?php echo __('Description');?></th>
                        <th style="width:10%" class="a-center"><?php echo __('Qty');?></th>
                        <th style="width:10%" class="a-right"><?php echo __('Rate');?></th>
                        <th style="width:20%" class="a-right"><?php echo __('Amount');?></th>
                    </tr>
                    <?php if (!empty($i['InvoiceLog'])) { ?>
                        ...
                        <?php } ?>
                    <?php } else { ?>
                        <tr><td colspan="5"><?php echo __('No records');?>......</td></tr>
                    <?php } ?>
                </table>
                <hr/>
                <?php if (!empty($i['InvoiceLog'])) { ?>
                    <div class="tol-amount">
                        <table class="inv-summary" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                                <td style="border-top:0px none;width:40%;"><?php echo __('Subtotal');?></td>
                                <td style="border-top:0px none;"><?php print number_format($grandTotal, 2, '.', ','); ?></td>
                            </tr>
                            <?php if (floatval($i['Invoice']['discount']) > 0) { ?>
                                <tr>
                                    <td><?php echo __('Discount');?><span class="percent"><?php print ($i['Invoice']['discount_type'] != 'Flat') ? '('.$i['Invoice']['discount'] . '%)' : ''; ?></span></td>
                                    <td>
                                        <?php
                            ...
                            <?php if (floatval($i['Invoice']['tax']) > 0) { ?>
                                <tr>
                                    <td><?php echo __('Tax');?><span class="percent">(<?php echo floatVal($i['Invoice']['tax']); ?>%)</span></td>
                                    <td>
                                        <?php
                            ...
                            <?php } ?>
                            <tr class="tot-tr">
                                <td class="tot-txt" style="border-right:0px;"><?php echo __('Total Amount');?></td>
                                <td class="tot-amt" style="border-left:0px;">
                                    <?php echo trim($i['Invoice']['currency']) != '' ? trim($i['Invoice']['currency']) : __('USD'); ?>
