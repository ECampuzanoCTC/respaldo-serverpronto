...
<form name="frm_create_invoice" id="frm_create_invoice" action="<?php echo $this->Html->url(array('controller'=>'invoices','action'=>'save_invoice','plugin'=>'Invoice'));?>" autocomplete="off">
    ...
    <div class="row">
        <div class="col-sm-7">
            ...
            <div class="lft_cnt_ig_frm" >
                ...
                <div class="frm_cnt_ig">
                    <label class="fld_ttl_ig" style="font-size:20px;">Customer</label>
                        ...
                        <tr>
                            ...
                            <td id="invoice_terms_disp123">
                                <?php if (!empty($i['Invoice']['invoice_term'])) {
                                    ...
                                    echo $invoice_term == 0 ? 'Due on receipt' : 'Net ' . $invoice_term;
                                }else{
                                    echo "---";
                                }
                                ?>
    ...
    <div class="InvoiceDownloadEmail fl" style="display: block;" >        
        <div class=" relative" style="left:35%;">
            <div class="mr20 fl relative inv_bts">
                ...
                <button class="btn btn_blue mr0 fl no-border-radius saveInvoice" id="emailInvoice" onclick="sendInvoiceEmail('<?php echo $invoice_id;?>');" title="<?php echo __('Send Email');?>"><?php echo __('Send');?></button>
            ...
            <span class="or_cancel cancel_on_direct_pj"><?php echo __('or');?> <a class="anchor" id="cancelInvoice" onclick="cancelInvoice();" title="<?php echo __('Cancel');?>"><?php echo __('Cancel');?></a></span>            
        </div>
    </div>
</div>
