...
Router::connect('/Invoice/:controller/:action', array('plugin' => 'Invoice'));

Router::connect('/Dashboard/:controller/:action', array('plugin' => 'Dashboard'));
...
Router::connect('/user-role-settings', array('plugin' => 'RoleManagement', 'controller' => 'Roles', 'action' => 'index'));
Router::connect('/RoleManagement/:controller/:action', array('plugin' => 'RoleManagement'));

Router::connect("/ProjectTemplate/:controller/:action",array('plugin' => 'ProjectTemplate'));
/* Expense management*/
Router::connect('/expense-budget', array('plugin' => 'Expense', 'controller' => 'Expense', 'action' => 'expensebudget'));
Router::connect('/expense/:controller/:action',array('plugin'=> 'Expense'));
Router::connect('/Expense/:controller/:action',array('plugin'=> 'Expense'));
/* for wiki */
Router::connect('/wiki-details', array('plugin' => 'Wiki', 'controller' => 'Wiki', 'action' => 'wikidetails'));
Router::connect('/wiki/:controller/:action',array('plugin'=> 'Wiki'));
Router::connect('/Wiki/:controller/:action',array('plugin'=> 'Wiki'));

/* cost settings page */
Router::connect("/cost-settings",array('controller' => 'users', 'action' => 'cost_settings'));
Router::connect("/save-cost-settings",array('controller' => 'users', 'action' => 'save_cost_settings'));
Router::connect("/salary-settings",array('controller' => 'users', 'action' => 'salary_settings'));
Router::connect("/default-rates",array('controller' => 'users', 'action' => 'default_rates'));
